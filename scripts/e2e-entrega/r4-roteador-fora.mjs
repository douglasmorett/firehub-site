// R4 (extra) — com o servidor subido com OSRM_URL numa porta fechada (roteador fora): GPS num
// ponto novo (sem rota no cache) → distância "estimada" (linha reta × fator da loja), a tela diz
// "estimada", e o pedido grava medida "estimada" e a nota. Reaproveita o fluxo do E6.
// (texto original do E6 abaixo)
