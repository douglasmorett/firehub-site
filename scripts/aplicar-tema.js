...
// Telas que o CLIENTE FINAL vê (loja pública, trilha dele, confirmar endereço,
// botão flutuante do layout raiz). O dono aprovou o tema do PAINEL; a loja do
// cliente não entra sem ele ver. Mesma lista em scripts/aplicar-paleta-brasa.js.
const FORA = [
