    ...
    <div style={{ display: "flex", minHeight: "100vh", backgroundColor: "var(--bg-body)" }}>
      ...
      <main style={{ flex: 1, marginLeft: "250px", padding: "2rem" }} className="admin-main-content">
        ...
        <div style={{
          ...
          <StatCard label="Pagos" value={stats.pagos} color="#0F766E" />
          <StatCard label="Entrega" value={stats.entrega} color="#1C1917" />
          <StatCard label="Finalizados" value={stats.finalizados} color="#0F766E" />
