...
export async function GET() {
  ...
  // Se não estiver conectado, gera um Pairing Code de 8 dígitos e URL de QR Code dinâmico
  ...
  // Simulação de sessão ativa com QR Code limpo SVG/DataURL
