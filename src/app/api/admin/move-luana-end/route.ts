...
export async function GET() {
  try {
    ...
    if (existing) {
      ...
      return NextResponse.json({ ok: true, message: "Pedido da Luana movido para o FINAL da fila com o horário atual!", id: updated.id, createdAt: updated.createdAt });
    }
    ...
    return NextResponse.json({ ok: true, message: "Pedido da Luana criado no FINAL da fila!", id: newOrder.id });
  } catch (err: any) {
