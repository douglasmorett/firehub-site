  ...
  if (checkoutSuccess) {
    return (
      <div style={{
        ...
        background: "linear-gradient(135deg, #1C1917 0%, #1C1917 60%, #42A5F5 100%)",
        padding: "1.5rem",
      }}>
        <div style={{
          ...
          {isSpecialStore ? (
            <div style={{
              background: "#F0FDFA", borderRadius: 14, padding: "1.25rem",
              marginBottom: "1.5rem", border: "1.5px solid #99F6E4",
              textAlign: "left"
            }}>
              <p style={{ color: "#0F766E", fontSize: "0.9rem", fontWeight: 700, marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: 6 }}>
                ✓ Conta de Registro
              </p>
              <p style={{ color: "#134E4A", fontSize: "0.82rem", lineHeight: 1.5 }}>
                Este pedido foi registrado com sucesso para fins de controle e histórico.
              </p>
              <p style={{ color: "#134E4A", fontSize: "0.82rem", lineHeight: 1.5, marginTop: "0.5rem" }}>
                ...
                <div style={{
                  ...
                  <button
                    ...
                    style={{
                      ...
                      background: copied ? "#0F766E" : "#1C1917", color: "#fff",
            ...
            <div style={{
              background: "#FFF4EF", borderRadius: 14, padding: "1.25rem",
              marginBottom: "1.5rem", border: "1.5px solid #FFD3C2",
              textAlign: "left"
            }}>
              <p style={{ color: "#9A3412", fontSize: "0.9rem", fontWeight: 700, marginBottom: "0.5rem", display: "flex", alignItems: "center", gap: 6 }}>
  ...
  return (
    <>
      ...
      <style>{`
        ...
        .cart-item-price { font-weight: 800; font-size: 1rem; color: #1C1917; white-space: nowrap; }
        .cart-remove-btn {
        ...
        .modal-agree-box {
          background: #F0F4FF; border: 1.5px solid #E7DDD3;
        ...
        <div className="cart-page-grid">
          ...
          <div className="cart-summary-card">
            ...
            <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "1rem" }}>
              ...
              <span style={{ color: "#0F766E", fontWeight: 700 }}>Grátis</span>
            </div>
            <div style={{
              ...
              <span style={{
                ...
                background: "linear-gradient(135deg, #1C1917, #42A5F5)",
