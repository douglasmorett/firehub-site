    ...
    <div style={{ minHeight: "100vh", background: "#F8FAFC", color: "#0F172A", fontFamily: "-apple-system, BlinkMacSystemFont, 'Segoe UI', Roboto, sans-serif" }}>
      ...
      <div style={{ maxWidth: "1100px", margin: "0 auto", padding: "2rem 1.5rem" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", marginBottom: "2.5rem" }}>
          ...
          {/* A Revolução FireHub */}
          <div style={{ background: "#FFF", border: "1.5px solid #ABEFC6", borderRadius: 20, padding: "1.5rem", boxShadow: "0 4px 14px rgba(34, 197, 94, 0.06)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, color: "#15803D", fontWeight: 900, fontSize: "1.1rem", marginBottom: 12 }}>
        ...
        <div style={{ background: "#FFF", borderRadius: 24, padding: "2rem", border: "1px solid #E2E8F0", boxShadow: "0 6px 20px rgba(0,0,0,0.04)", marginBottom: "2.5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(4, 1fr)", gap: "1rem" }}>
            ...
            <div style={{ background: "#ECFDF3", border: "1.5px solid #ABEFC6", borderRadius: 16, padding: "1.2rem", textAlign: "center" }}>
              <div style={{ fontSize: "1.5rem", fontWeight: 900, color: "#15803D" }}>38 min</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "1.5rem", marginBottom: "2.5rem" }}>
          ...
          <div style={{ background: "#FFF", borderRadius: 20, padding: "1.75rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 14px rgba(0,0,0,0.04)" }}>
            <div style={{ display: "flex", alignItems: "center", gap: 10, marginBottom: 12 }}>
              <div style={{ width: 36, height: 36, borderRadius: 10, background: "#EFF6FF", color: "#1D4ED8", display: "flex", alignItems: "center", justifyContent: "center" }}>
                <Bot size={20} />
              </div>
              <div>
        ...
        <div style={{ background: "#FFF", borderRadius: 24, padding: "2rem", border: "1px solid #E2E8F0", boxShadow: "0 6px 20px rgba(0,0,0,0.04)", marginBottom: "2.5rem" }}>
          ...
          <div style={{ display: "grid", gridTemplateColumns: "repeat(3, 1fr)", gap: "1.25rem" }}>
            ...
            <div style={{ background: "#F8FAFC", borderRadius: 16, padding: "1.25rem", border: "1px solid #E2E8F0" }}>
              ...
              {STORE_URL ? (
                <a
                  ...
                  rel="noopener noreferrer"
                  style={{
                    background: "#EFF6FF", border: "1px solid #B2DDFF", color: "#1D4ED8",
            ...
            <div style={{ background: "#F8FAFC", borderRadius: 16, padding: "1.25rem", border: "1px solid #E2E8F0" }}>
              <div style={{ width: 32, height: 32, borderRadius: 10, background: "#1D4ED8", color: "#FFF", fontWeight: 900, display: "flex", alignItems: "center", justifyContent: "center", marginBottom: 12 }}>
                2
              </div>
          ...
          {extensaoInstalada && (
            <div style={{ marginTop: "1.25rem", background: "#ECFDF3", border: "1.5px solid #ABEFC6", borderRadius: 14, padding: "12px 16px", display: "flex", alignItems: "center", gap: 10 }}>
        ...
        <div style={{ textAlign: "center", marginTop: "3rem", paddingBottom: "2rem" }}>
          {extensaoInstalada ? (
            <div style={{ display: "inline-flex", alignItems: "center", gap: 10, padding: "16px 36px", borderRadius: 16, background: "#ECFDF3", border: "2px solid #ABEFC6", color: "#15803D", fontWeight: 900, fontSize: "1.05rem" }}>
