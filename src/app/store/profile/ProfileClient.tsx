    ...
    <div className="container" style={{ maxWidth: "600px", marginTop: "2rem" }}>
      ...
      <div className="card mb-6">
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", paddingBottom: "0.5rem", borderBottom: "1px solid var(--border-color)" }}>
          ...
          {profileSuccess && <span style={{ fontSize: "0.8rem", color: "#15803D", fontWeight: 600 }}>✅ Salvo!</span>}
        </div>
      ...
      <div className="card">
        ...
        {success && (
          <div style={{ backgroundColor: "rgba(16,185,129,0.1)", color: "#15803D", padding: "1rem", borderRadius: "8px", display: "flex", alignItems: "center", gap: "0.5rem", marginBottom: "1rem", fontWeight: "bold" }}>
