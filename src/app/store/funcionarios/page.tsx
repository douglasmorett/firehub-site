  ...
  return (
    <div style={{ padding: "20px", maxWidth: 1200, margin: "0 auto", fontFamily: "'Inter', sans-serif" }}>
      ...
      >
        ...
        <div
          style={{
            ...
            border: `1.5px solid ${enabled ? "#ABEFC6" : "#E2E8F0"}`,
            padding: "8px 16px",
            borderRadius: 12,
          }}
        >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(240px, 1fr))", gap: 16, marginBottom: 20 }}>
        ...
        <div style={{ background: "linear-gradient(135deg, #ECFDF3, #ECFDF3)", border: "1.5px solid #ABEFC6", borderRadius: 14, padding: "16px" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            <span style={{ fontSize: "0.78rem", fontWeight: 700, color: "#15803D", textTransform: "uppercase" }}>Abatidos / Pagos (Período)</span>
            <DollarSign size={18} color="#15803D" />
          </div>
          <div style={{ fontSize: "1.6rem", fontWeight: 900, color: "#15803D" }}>{fmt(periodAbatedSum)}</div>
          <div style={{ fontSize: "0.75rem", color: "#15803D", marginTop: 4 }}>Baixas registradas no extrato</div>
        </div>
                ...
                <div>
                  <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", marginBottom: 8 }}>
                    ...
                    <div style={{ textAlign: "right" }}>
                      <span style={{ fontSize: "0.7rem", fontWeight: 700, color: hasDebt ? "#B71C1C" : "#15803D", textTransform: "uppercase" }}>
                        {hasDebt ? "Débito Pendente" : "Quitado"}
                      </span>
                      <div style={{ fontSize: "1.25rem", fontWeight: 900, color: hasDebt ? "#C92E09" : "#15803D" }}>
                        {fmt(emp.currentDebt)}
                      </div>
                    </div>
                  </div>
                  ...
                  <div style={{ fontSize: "0.78rem", color: "#64748B", background: "#F8FAFC", padding: "8px 10px", borderRadius: 8, margin: "10px 0 14px", display: "grid", gridTemplateColumns: "1fr 1fr", gap: 6 }}>
                    ...
                    <div>
                      Abatido Período: <strong style={{ color: "#15803D" }}>{fmt(emp.periodPaymentsAmount)}</strong>
                    </div>
                    {emp.creditLimit && (
        ...
        <div style={{ position: "fixed", inset: 0, background: "rgba(15,23,42,0.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, padding: 16 }}>
          <div style={{ background: "#fff", borderRadius: 16, width: "100%", maxWidth: 420, padding: 20, boxShadow: "0 20px 25px -5px rgba(0,0,0,0.1)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 12 }}>
              <h3 style={{ margin: 0, fontWeight: 800, fontSize: "1.1rem", color: "#15803D" }}>💸 Registar Abatimento / Baixa</h3>
              <button onClick={() => setAbateEmp(null)} style={{ border: "none", background: "none", cursor: "pointer", color: "#64748B" }}>
                <X size={20} />
              </button>
            </div>

            <div style={{ background: "#ECFDF3", border: "1px solid #ABEFC6", borderRadius: 10, padding: "10px 12px", marginBottom: 14 }}>
              <div style={{ fontSize: "0.82rem", color: "#15803D" }}>Colaborador: <strong>{abateEmp.name}</strong></div>
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: 12 }}>
              <div>
                ...
                <input
                  ...
                  placeholder="Ex: 300.00"
                  style={{ width: "100%", padding: "10px 12px", borderRadius: 8, border: "2px solid #15803D", fontSize: "1.1rem", fontWeight: 800, outline: "none" }}
                />
            ...
            <div style={{ display: "flex", gap: 10, marginTop: 18 }}>
              ...
              <button
                ...
                style={{ flex: 1, padding: "10px", borderRadius: 10, border: "none", background: "#15803D", color: "#fff", fontWeight: 700, fontSize: "0.85rem", cursor: "pointer" }}
              >
                ...
                statementData.map((item) => (
                  <div
                    ...
                    style={{
                      padding: "10px 12px",
                      borderRadius: 10,
                      border: `1.5px solid ${item.type === "ORDER" ? "#FECACA" : "#ABEFC6"}`,
                      background: item.type === "ORDER" ? "#FFF1F2" : "#ECFDF3",
                      display: "flex",
                      justifyContent: "space-between",
                      alignItems: "center",
                    }}
                  >
                    <div>
                      <div style={{ fontWeight: 700, fontSize: "0.85rem", color: item.type === "ORDER" ? "#B71C1C" : "#15803D" }}>
                        {item.title}
                      </div>
                    ...
                    <div style={{ fontWeight: 900, fontSize: "0.95rem", color: item.type === "ORDER" ? "#C92E09" : "#15803D" }}>
