    ...
    <div style={{ padding: 20, maxWidth: viewingWaiter || verRelatorioDeMesas ? 1200 : 1000, margin: "0 auto" }}>
      ...
      {verRelatorioDeMesas ? (
        ...
        <>
          ...
          {/* ─── LINK DE ACESSO DO GARÇOM ─── */}
          <div style={{ background: "linear-gradient(135deg, #F8FAFC, #EEF2FF)", border: "1px solid #E2E8F0", borderRadius: 14, padding: 18, marginBottom: 20 }}>
            ...
            {linkDoGarcom ? (
              <div style={{ display: "flex", gap: 8, flexWrap: "wrap" }}>
                ...
                <button type="button" onClick={copiarLink} style={{
                  background: copiado ? "#15803D" : "#475569", color: "#fff", border: "none", padding: "10px 14px",
                    ...
                    <tr key={w.id} style={{ borderBottom: "1px solid #E2E8F0", cursor: "pointer" }} onClick={() => openReport(w)}>
                      <td style={{ padding: "14px 16px", fontWeight: 600, color: "#1E293B" }}>
                        <div style={{ display: "flex", alignItems: "center", gap: 8 }}>
                          <div style={{ width: 32, height: 32, borderRadius: "50%", background: "#F0EDFF", color: "#475569", display: "flex", alignItems: "center", justifyContent: "center", fontWeight: 800 }}>
                      ...
                      <td style={{ padding: "14px 16px" }}>
                        <span style={{
                          background: w.active ? "#ECFDF3" : "#FEE2E2",
                          color: w.active ? "#15803D" : "#C92E09",
                      ...
                      <td style={{ padding: "14px 16px", textAlign: "right" }} onClick={e => e.stopPropagation()}>
                        ...
                        <button onClick={() => openEdit(w)} style={{ background: "none", border: "none", color: "#1D4ED8", cursor: "pointer", marginRight: 8 }}><Edit2 size={18} /></button>
                ...
                {reportLoading ? (
                  ...
                  reportSessions.map(s => (
                    <tr key={s.id} style={{ borderBottom: "1px solid #E2E8F0" }}>
                      ...
                      <td style={{ padding: "14px 16px" }}>
                        {s.serviceFee > 0 ? (
                          <div style={{ display: "flex", alignItems: "center", gap: 4, color: "#15803D", fontWeight: 700, fontSize: 14 }}>
