...
export default function ChatbotHubClient() {
  ...
  const handleConfirmDeleteCoupon = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showToast(`🗑️ Cupom "${codeToDelete}" excluído permanentemente!`, "#0F766E");
  ...
  const handleGerarCodigo = async () => {
    ...
    try {
      ...
      if (d?.jaConectada) {
        showToast("✅ Este WhatsApp já está conectado!", "#0F766E");
        return;
      }
  ...
  const handleFetchFreshQr = async () => {
    try {
      ...
      if (res.connected) {
        ...
        setQrTimer(60);
        setIsQrExpired(false);
        showToast("⚡ QR Code gerado em tempo real! Expira em 60 segundos.", "#1C1917");
      } else {
  ...
  const showToast = (msg: string, color: string = "#0F766E") => {
    setToast({ msg, color });
  ...
  const loadMarketingData = async (isManualClick = false) => {
    ...
    try {
      ...
      if (res.success) {
        ...
        if (isManualClick) {
          showToast("📊 Métricas e disparos atualizados com sucesso!", "#0F766E");
        }
      }
    } catch (e) {
    ...
    try {
      ...
      if (res.ok) {
        ...
        if (perdidos.length > 0) {
          ...
          showToast("✅ Configurações salvas!", "#0F766E");
        }
      }
    } catch (err) {
  ...
  const handleSaveStorePhone = async () => {
    ...
    try {
      ...
      if (res.ok) {
        ...
        showToast("🎉 WhatsApp vinculado com sucesso ao número " + cleanPhone, "#0F766E");
      } else {
  ...
  const handleSendTestMessage = async () => {
    ...
    try {
      ...
      if (res.ok) {
        showToast("🚀 Mensagem de teste enviada com sucesso!", "#0F766E");
      } else {
    ...
    <div style={{ maxWidth: "1200px", margin: "0 auto", padding: "24px 16px", fontFamily: "inherit" }}>
      ...
      {!config.connected && (
        <div
          ...
          style={{ display: "flex", alignItems: "center", gap: "0.9rem", flexWrap: "wrap", background: "#F0FDFA", border: "1px solid #99F6E4", borderLeft: "6px solid #0F766E", borderRadius: 12, padding: "0.9rem 1.1rem", marginBottom: "1rem", cursor: "pointer" }}
        >
          ...
          <span style={{ background: "#0F766E", color: "#fff", fontWeight: 800, fontSize: "0.9rem", padding: "0.6rem 1.1rem", borderRadius: 10, whiteSpace: "nowrap" }}>
      ...
      <div style={{ background: "linear-gradient(135deg, #0F172A 0%, #1E293B 100%)", borderRadius: "20px", padding: "28px", color: "#fff", marginBottom: "24px", boxShadow: "0 10px 30px rgba(0,0,0,0.15)" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: "16px" }}>
          <div>
            <div style={{ display: "inline-flex", alignItems: "center", gap: "6px", background: "rgba(15, 118, 110,0.15)", border: "1px solid rgba(15, 118, 110,0.3)", padding: "4px 12px", borderRadius: "20px", fontSize: "0.75rem", fontWeight: 800, color: "#5EEAD4", marginBottom: "10px" }}>
        ...
        <div style={{ display: "flex", gap: "8px", marginTop: "24px", flexWrap: "wrap" }}>
          <button
            ...
            style={{
              ...
              background: activeTab === "qr" ? "#0F766E" : "rgba(255,255,255,0.1)", color: "#fff",
          ...
          <button
            ...
            style={{
              padding: "10px 18px", borderRadius: "12px", border: "none", fontWeight: 800, fontSize: "0.84rem", cursor: "pointer",
              background: activeTab === "cardapio" ? "linear-gradient(135deg, #0F766E, #0F766E)" : "rgba(255,255,255,0.1)", color: "#fff",
              display: "flex", alignItems: "center", gap: "8px", boxShadow: activeTab === "cardapio" ? "0 4px 12px rgba(15, 118, 110,0.3)" : "none"
            }}
          >
            📄 Cardápio em Arquivo
          </button>
          <button
            ...
            style={{
              padding: "10px 18px", borderRadius: "12px", border: "none", fontWeight: 800, fontSize: "0.84rem", cursor: "pointer",
              background: activeTab === "test" ? "#E8590C" : "rgba(255,255,255,0.1)", color: "#fff",
              display: "flex", alignItems: "center", gap: "8px"
            }}
          >
          ...
          <button
            ...
            style={{
              padding: "10px 18px", borderRadius: "12px", border: "none", fontWeight: 800, fontSize: "0.84rem", cursor: "pointer",
              background: activeTab === "diagnostic" ? "#44403C" : "rgba(255,255,255,0.1)", color: "#fff",
              display: "flex", alignItems: "center", gap: "8px"
            }}
          >
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(360px, 1fr))", gap: "1.5rem" }}>
        ...
        <div style={{ display: "flex", flexDirection: "column", gap: "1.5rem" }}>
            ...
            <div style={{ background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                  <div style={{ width: 36, height: 36, borderRadius: "10px", background: "#F0FDFA", color: "#0F766E", display: "flex", alignItems: "center", justifyContent: "center" }}>
                    <QrCode size={20} />
                  </div>
                  <div>
              ...
              {!config.connected ? (
                <div style={{ background: "#F8FAFC", borderRadius: "12px", padding: "1.5rem", textAlign: "center", border: "1px dashed #CBD5E1" }}>
                  ...
                  <div style={{ background: "#fff", padding: "14px", borderRadius: "10px", border: "1px solid #E2E8F0", textAlign: "left" }}>
                    ...
                    {codigoPareamento && (
                      <div style={{ marginTop: "14px", background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: "10px", padding: "14px" }}>
                        <div style={{ fontSize: "0.75rem", fontWeight: 800, color: "#0F766E", marginBottom: "6px" }}>
                          SEU CÓDIGO
                        </div>
                        <div
                          style={{
                            ...
                            color: "#134E4A", marginBottom: "10px",
                          }}
                        >
                          {codigoPareamento}
                        </div>
                        <div style={{ fontSize: "0.8rem", color: "#0F766E", lineHeight: 1.7 }}>
                        ...
                        <div style={{ fontSize: "0.72rem", color: "#0F766E", marginTop: "8px" }}>
                ...
                <div style={{ background: "#F0FDFA", borderRadius: "12px", padding: "1.25rem", border: "1px solid #99F6E4", display: "flex", flexDirection: "column", gap: "12px" }}>
          ...
          {activeTab === "phone" && (
            <div style={{ background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem" }}>
                <div style={{ width: 36, height: 36, borderRadius: "10px", background: "#FAF6F2", color: "#1C1917", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Phone size={20} />
                </div>
                <div>
          ...
          {activeTab === "marketing" && (
            <div style={{ background: "#fff", borderRadius: "20px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 10px 25px -5px rgba(0,0,0,0.05)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(220px, 1fr))", gap: "12px", marginBottom: "1.5rem" }}>
                <div style={{ background: "#FAF6F2", border: "1px solid #E2E8F0", padding: "1.2rem", borderRadius: "14px", textAlign: "center" }}>
                ...
                <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", padding: "1.2rem", borderRadius: "14px", textAlign: "center" }}>
                  <div style={{ color: "#0F766E", fontSize: "0.75rem", fontWeight: 800, textTransform: "uppercase" }}>🛍️ Pedidos Recuperados</div>
                  <div style={{ fontSize: "1.6rem", fontWeight: 900, color: "#0F766E", marginTop: "4px" }}>{recoveredOrdersCount}</div>
                  <div style={{ fontSize: "0.7rem", color: "#0F766E", marginTop: "2px" }}>Vendas efetuadas via cupons</div>
                </div>
              ...
              <div style={{ background: "linear-gradient(135deg, #FAF6F2, #FAF6F2)", padding: "1.5rem", borderRadius: "16px", border: "1px solid #E7DDD3", marginBottom: "1.5rem" }}>
                <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "10px", marginBottom: "10px" }}>
                  <div>
                    <div style={{ fontWeight: 800, fontSize: "1rem", color: "#1C1917", display: "flex", alignItems: "center", gap: "6px" }}>
                      💬 Se o cliente perguntar se tem cupom de desconto no WhatsApp, quer liberar um cupom automático?
                    </div>
                    <div style={{ fontSize: "0.78rem", color: "#1C1917", marginTop: "2px" }}>
                  ...
                  <div style={{ display: "flex", gap: "6px" }}>
                    <button
                      ...
                      style={{ padding: "6px 16px", borderRadius: "8px", border: "none", background: config.instantCouponEnabled === true ? "#0F766E" : "#E2E8F0", color: config.instantCouponEnabled === true ? "#fff" : "#475569", fontWeight: 800, fontSize: "0.8rem", cursor: "pointer" }}
                    >
                      SIM, LIBERAR
                    </button>
                    <button
                ...
                {config.instantCouponEnabled === true && (
                  <div style={{ background: "#fff", padding: "1rem", borderRadius: "12px", border: "1px solid #E7DDD3", display: "grid", gridTemplateColumns: "1fr 1fr", gap: "12px", marginTop: "12px" }}>
                    <div>
                      <label style={{ display: "block", fontSize: "0.76rem", fontWeight: 800, color: "#1C1917", marginBottom: "4px" }}>
                      ...
                      <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
                        <select
                          ...
                          style={{ flex: 1, padding: "8px 12px", borderRadius: "8px", border: "1px solid #E7DDD3", fontSize: "0.85rem", fontWeight: 700, color: "#1C1917" }}
                        >
                      ...
                      <button
                        ...
                        style={{ marginTop: "6px", background: "none", border: "none", color: "#1C1917", fontWeight: 800, fontSize: "0.76rem", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: "4px" }}
                      >
                        ➕ Criar Novo Cupom
                      </button>
                    </div>
                    ...
                    <div>
                      ...
                      <input
                        ...
                        style={{ width: "100%", padding: "8px 12px", borderRadius: "8px", border: "1px solid #E7DDD3", fontSize: "0.85rem", boxSizing: "border-box" }}
                      />
                    </div>
                  </div>
                )}
              ...
              <div style={{ background: "#F8FAFC", padding: "1.5rem", borderRadius: "16px", border: "1px solid #E2E8F0", marginBottom: "1.5rem" }}>
                ...
                <div style={{ background: "#fff", padding: "1rem", borderRadius: "14px", border: "1px solid #CBD5E1", marginBottom: "1rem", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "10px" }}>
                    <div style={{ fontWeight: 800, fontSize: "0.88rem", color: "#E8590C" }}>🔥 1º Incentivo — Cliente 7 Dias Sem Pedir</div>
                    <div style={{ display: "flex", gap: "6px" }}>
                      <button onClick={() => handleSaveConfig({ autoRecuperation7d: true })} style={{ padding: "4px 12px", borderRadius: "6px", border: "none", background: config.autoRecuperation7d === true ? "#0F766E" : "#E2E8F0", color: config.autoRecuperation7d === true ? "#fff" : "#475569", fontWeight: 800, fontSize: "0.74rem", cursor: "pointer" }}>ATIVADO</button>
                    ...
                    <div>
                      ...
                      <div style={{ display: "flex", gap: "6px", alignItems: "center" }}>
                        <select
                          ...
                          style={{ flex: 1, padding: "8px", borderRadius: "8px", border: "1px solid #CBD5E1", fontSize: "0.82rem", fontWeight: 800, color: "#1C1917" }}
                        >
                      ...
                      {config.img7d ? (
                        ...
                        <label style={{ display: "flex", alignItems: "center", gap: "6px", padding: "8px 14px", borderRadius: "10px", border: "2px dashed #CBD5E1", background: "#F8FAFC", cursor: "pointer", fontSize: "0.78rem", fontWeight: 700, color: "#64748B" }}>
                          ...
                          <input type="file" accept="image/*" hidden onChange={async (e) => {
                            ...
                            if (res.ok) { const { url } = await res.json(); setConfig((p: any) => ({ ...p, img7d: url })); handleSaveConfig({ img7d: url }); showToast("✅ Imagem salva!", "#0F766E"); }
                          }} />
                        </label>
                      )}
                    </div>
                ...
                <div style={{ background: "#fff", padding: "1rem", borderRadius: "14px", border: "1px solid #CBD5E1", marginBottom: "1rem", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "10px" }}>
                    <div style={{ fontWeight: 800, fontSize: "0.88rem", color: "#1C1917" }}>🎁 2º Incentivo — Cliente 15 Dias Sem Pedir</div>
                    <div style={{ display: "flex", gap: "6px" }}>
                      <button onClick={() => handleSaveConfig({ autoRecuperation15d: true })} style={{ padding: "4px 12px", borderRadius: "6px", border: "none", background: config.autoRecuperation15d === true ? "#0F766E" : "#E2E8F0", color: config.autoRecuperation15d === true ? "#fff" : "#475569", fontWeight: 800, fontSize: "0.74rem", cursor: "pointer" }}>ATIVADO</button>
                      ...
                      {config.img15d ? (
                        ...
                        <label style={{ display: "flex", alignItems: "center", gap: "6px", padding: "8px 14px", borderRadius: "10px", border: "2px dashed #CBD5E1", background: "#F8FAFC", cursor: "pointer", fontSize: "0.78rem", fontWeight: 700, color: "#64748B" }}>
                          ...
                          <input type="file" accept="image/*" hidden onChange={async (e) => {
                            ...
                            const fd = new FormData(); fd.append("file", file); fd.append("type", "marketing");
                            const res = await fetch("/api/upload", { method: "POST", body: fd });
                            if (res.ok) { const { url } = await res.json(); setConfig((p: any) => ({ ...p, img15d: url })); handleSaveConfig({ img15d: url }); showToast("✅ Imagem salva!", "#0F766E"); }
                          }} />
                        </label>
                      )}
                    </div>
                ...
                <div style={{ background: "#fff", padding: "1rem", borderRadius: "14px", border: "1px solid #CBD5E1", boxShadow: "0 2px 4px rgba(0,0,0,0.02)" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "10px" }}>
                    ...
                    <div style={{ display: "flex", gap: "6px" }}>
                      <button onClick={() => handleSaveConfig({ autoRecuperation30d: true })} style={{ padding: "4px 12px", borderRadius: "6px", border: "none", background: config.autoRecuperation30d === true ? "#0F766E" : "#E2E8F0", color: config.autoRecuperation30d === true ? "#fff" : "#475569", fontWeight: 800, fontSize: "0.74rem", cursor: "pointer" }}>ATIVADO</button>
                      ...
                      {config.img30d ? (
                        ...
                        <label style={{ display: "flex", alignItems: "center", gap: "6px", padding: "8px 14px", borderRadius: "10px", border: "2px dashed #CBD5E1", background: "#F8FAFC", cursor: "pointer", fontSize: "0.78rem", fontWeight: 700, color: "#64748B" }}>
                          ...
                          <input type="file" accept="image/*" hidden onChange={async (e) => {
                            ...
                            const fd = new FormData(); fd.append("file", file); fd.append("type", "marketing");
                            const res = await fetch("/api/upload", { method: "POST", body: fd });
                            if (res.ok) { const { url } = await res.json(); setConfig((p: any) => ({ ...p, img30d: url })); handleSaveConfig({ img30d: url }); showToast("✅ Imagem salva!", "#0F766E"); }
                          }} />
                        </label>
                      )}
                    </div>
                ...
                <div style={{ background: "#fff", padding: "1.25rem", borderRadius: "14px", border: "1px solid #CBD5E1", marginTop: "1rem" }}>
                  <div style={{ fontWeight: 800, fontSize: "0.92rem", color: "#0F172A", marginBottom: "0.75rem", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <button
                      ...
                      style={{ background: "#FAF6F2", border: "1px solid #E7DDD3", color: "#1C1917", padding: "4px 10px", borderRadius: "8px", fontWeight: 800, fontSize: "0.75rem", cursor: "pointer" }}
                    >
                      ➕ Criar Cupom
                    </button>
                  </div>
                      ...
                      {marketingCustomers.length === 0 ? (
                        ...
                        marketingCustomers.map((c: any) => (
                          <tr key={c.id} style={{ borderBottom: "1px solid #F1F5F9" }}>
                            ...
                            <td style={{ padding: "8px 12px", color: "#1C1917", fontWeight: 700 }}>{c.phone}</td>
          ...
          {activeTab === "notifications" && (
            <div style={{ background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem" }}>
                <div style={{ width: 36, height: 36, borderRadius: "10px", background: "#FAF6F2", color: "#475569", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Bell size={20} />
                </div>
                <div>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "12px" }}>
                ...
                <button
                  onClick={() => showToast("✅ Mensagens salvas com sucesso!", "#0F766E")}
                  ...
                  <div style={{ display: "flex", gap: "8px" }}>
                    <button
                      ...
                      style={{
                        ...
                        background: config.escalateOnComplaint !== false ? "#0F766E" : "#E2E8F0",
                    ...
                    {TIPOS_DE_ALERTA.map((t) => (
                      <label
                        ...
                        style={{
                          ...
                          background: ligado(t.id) ? "#FAF6F2" : "#F8FAFC", cursor: "pointer",
                        }}
                      >
                        <input
                          type="checkbox"
          ...
          {activeTab === "disparos" && (() => {
            const criteriaOptions = [
              { id: "all", label: "📋 Todos os Clientes", description: "Enviar para toda a base de contatos", color: "#1C1917", icon: "📋" },
              { id: "7d", label: "🔥 Sumidos há 7 Dias", description: "Clientes que não pedem há 7 dias ou mais", color: "#E8590C", icon: "🔥" },
              { id: "15d", label: "⏰ Sumidos há 15 Dias", description: "Clientes que não pedem há 15 dias ou mais", color: "#1C1917", icon: "⏰" },
              { id: "30d", label: "💤 Sumidos há 30+ Dias", description: "Clientes inativos há mais de 30 dias", color: "#475569", icon: "💤" },
              { id: "loyal", label: "⭐ Clientes Fiéis", description: "Clientes com 3 ou mais pedidos feitos", color: "#0F766E", icon: "⭐" },
              { id: "top_spenders", label: "👑 Top Clientes (VIP)", description: "Os 20 clientes que mais fizeram pedidos", color: "#B45309", icon: "👑" },
              { id: "new_customers", label: "🆕 Clientes Novos", description: "Clientes com apenas 1 pedido — conquiste a fidelização", color: "#44403C", icon: "🆕" },
            ...
            const handleSendCampaign = async () => {
              ...
              try {
                ...
                const data = await res.json();
                if (data.success) {
                  showToast(data.message || "🚀 Disparo iniciado com sucesso!", "#0F766E");
            ...
            return (
              <div style={{ background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  <div style={{ marginTop: "10px", padding: "10px 14px", borderRadius: "10px", background: "linear-gradient(135deg, #FFF7E6, #FDE68A)", border: "1px solid #FDE68A", display: "flex", alignItems: "center", gap: "8px" }}>
                    ...
                    <button
                      ...
                      style={{
                        ...
                        background: isGeneratingAi
                          ? "#94A3B8"
                          : "linear-gradient(135deg, #64748B, #C92E09)",
                        color: "#fff",
                        fontSize: "0.76rem",
                        fontWeight: 800,
                ...
                <div style={{ marginBottom: "1.5rem" }}>
                  ...
                  {campaignImg ? (
                    <div style={{ display: "flex", alignItems: "center", gap: "12px" }}>
                      ...
                      <div>
                        <div style={{ fontSize: "0.78rem", fontWeight: 800, color: "#0F766E" }}>✅ Imagem carregada</div>
                    ...
                    <label style={{
                      ...
                      <input type="file" accept="image/*" hidden disabled={campaignImgUploading} onChange={async (e) => {
                        ...
                        try {
                          const fd = new FormData(); fd.append("file", file); fd.append("type", "marketing");
                          const res = await fetch("/api/upload", { method: "POST", body: fd });
                          if (res.ok) { const { url } = await res.json(); setCampaignImg(url); showToast("✅ Imagem carregada!", "#0F766E"); }
                ...
                {/* Prévia do Disparo */}
                <div style={{ background: "#F0FDFA", borderRadius: "14px", padding: "16px", border: "1px solid #99F6E4", marginBottom: "1.5rem" }}>
                  <div style={{ fontWeight: 800, fontSize: "0.82rem", color: "#0F766E", marginBottom: "8px", display: "flex", alignItems: "center", gap: "6px" }}>
                    📱 Prévia do Disparo
                  </div>
                  <div style={{ background: "#fff", borderRadius: "12px", padding: "12px", border: "1px solid #F0FDFA", maxWidth: "340px" }}>
                    {campaignImg && (
                ...
                <div id="history-section" style={{ marginTop: "2rem", background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0" }}>
                  <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem", flexWrap: "wrap", gap: "10px" }}>
                    <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                      <div style={{ width: 36, height: 36, borderRadius: "10px", background: "linear-gradient(135deg, #0F766E, #0F766E)", color: "#fff", display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.1rem" }}>
                        📊
                      </div>
                      <div>
                  ...
                  <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "10px", marginBottom: "1.5rem" }}>
                    ...
                    <div style={{ background: "#FAF6F2", padding: "12px 14px", borderRadius: "12px", border: "1px solid #E7DDD3" }}>
                      <div style={{ fontSize: "0.7rem", fontWeight: 700, color: "#1C1917" }}>👥 Total de Envios</div>
                      <div style={{ fontSize: "1.2rem", fontWeight: 900, color: "#1C1917", marginTop: "2px" }}>
                    ...
                    <div style={{ background: "#F0FDFA", padding: "12px 14px", borderRadius: "12px", border: "1px solid #99F6E4" }}>
                      <div style={{ fontSize: "0.7rem", fontWeight: 700, color: "#0F766E" }}>🛒 Pedidos Convertidos</div>
                      <div style={{ fontSize: "1.2rem", fontWeight: 900, color: "#134E4A", marginTop: "2px" }}>
                    ...
                    <div style={{ background: "#F0FDFA", padding: "12px 14px", borderRadius: "12px", border: "1px solid #99F6E4" }}>
                      <div style={{ fontSize: "0.7rem", fontWeight: 700, color: "#0F766E" }}>💚 Lucro Estimado</div>
                        ...
                        return (
                          <div key={camp.id || i} style={{ background: "#F8FAFC", borderRadius: "12px", padding: "14px", border: "1px solid #E2E8F0" }}>
                            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start", gap: "10px", marginBottom: "8px" }}>
                              <div>
                                {camp.status === "DISPARANDO" ? (
                                  <span style={{ fontSize: "0.72rem", fontWeight: 800, color: "#B45309", background: "#FFF7E6", padding: "2px 10px", borderRadius: "6px", border: "1px solid #FDE68A", marginRight: "8px", display: "inline-flex", alignItems: "center", gap: "4px" }}>
                                    ⏳ Disparando em segundo plano ({camp.sentCount || 0} / {camp.targetCount || 0} enviados)
                                  </span>
                                ) : (
                                  <span style={{ fontSize: "0.72rem", fontWeight: 800, color: "#0F766E", background: "#F0FDFA", padding: "2px 8px", borderRadius: "6px", marginRight: "8px" }}>
                                    ✅ Concluído
                                  </span>
                                )}
                            ...
                            <div style={{ display: "flex", gap: "12px", flexWrap: "wrap", alignItems: "center", fontSize: "0.75rem", background: "#F1F5F9", padding: "8px 12px", borderRadius: "8px" }}>
                              ...
                              <span style={{ fontWeight: 800, color: "#1C1917" }}>✅ Entregues: <b>{totalSent} msgs</b></span>
                              <span style={{ color: "#CBD5E1" }}>|</span>
                              ...
                              <span style={{ color: "#CBD5E1" }}>|</span>
                              <span style={{ fontWeight: 800, color: "#0F766E" }}>🛒 Vendas: <b>{camp.convertedOrders || 0} pedidos</b></span>
                              <span style={{ color: "#CBD5E1" }}>|</span>
                              <span style={{ fontWeight: 800, color: "#B45309" }}>💰 Faturamento: <b>R$ {(camp.convertedRevenue || 0).toFixed(2)}</b></span>
                              <span style={{ color: "#CBD5E1" }}>|</span>
                              <span style={{ fontWeight: 900, color: "#0F766E" }}>💚 Lucro Gerado: <b>R$ {(camp.estimatedProfit || 0).toFixed(2)}</b></span>
                            </div>
                          </div>
                        );
                      })}
          ...
          {activeTab === "cardapio" && (
            <div style={{ background: "#fff", borderRadius: "16px", padding: "24px", border: "1px solid #E2E8F0" }}>
              ...
              <p style={{ color: "#475569", fontSize: "0.88rem", margin: "0 0 20px", lineHeight: 1.6 }}>
                ...
                o robô manda <strong style={{ color: "#0F766E" }}>primeiro o link do site</strong> (é lá que o pedido
              ...
              <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: "12px", padding: "14px 16px", marginBottom: "20px" }}>
                <div style={{ color: "#0F766E", fontSize: "0.8rem", fontWeight: 800, marginBottom: "6px" }}>ORDEM QUE O ROBÔ SEGUE</div>
                <div style={{ color: "#0F766E", fontSize: "0.83rem", lineHeight: 1.8 }}>
              ...
              <label style={{ display: "inline-flex", alignItems: "center", gap: "10px", padding: "12px 22px", borderRadius: "12px",
                background: menuFileSaving ? "#CBD5E1" : "linear-gradient(135deg, #0F766E, #0F766E)", color: "#fff",
          ...
          {activeTab === "test" && (
            <div style={{ background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px", marginBottom: "1rem" }}>
                <div style={{ width: 36, height: 36, borderRadius: "10px", background: "#FFF4EF", color: "#E8590C", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Send size={20} />
                </div>
                <div>
              ...
              <button
                ...
                style={{
                  width: "100%", padding: "12px", borderRadius: "10px", border: "none",
                  background: "linear-gradient(135deg, #E8590C, #9A3412)", color: "#fff",
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "8px" }}>
                {[
                  ...
                  <div key={idx} style={{ display: "flex", alignItems: "center", justifyContent: "space-between", padding: "10px 14px", background: "#F8FAFC", borderRadius: "10px", border: "1px solid #E2E8F0" }}>
                    ...
                    <span style={{ fontSize: "0.75rem", fontWeight: 800, padding: "3px 10px", borderRadius: "12px", background: item.ok ? "#F0FDFA" : "#FEE2E2", color: item.ok ? "#0F766E" : "#B71C1C" }}>
                ...
                <button
                  onClick={async () => {
                    ...
                    try {
                      ...
                      if (r.ok) {
                        showToast("🔄 " + (j.message || "Instância reiniciada!"), "#0F766E");
                      } else {
                  ...
                  style={{
                    ...
                    background: reparandoSessao ? "#FDE68A" : "linear-gradient(135deg, #B45309, #B45309)", color: "#fff",
          ...
          <div style={{ background: "#fff", borderRadius: "16px", padding: "1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
              ...
              {[
                ...
                <div
                  ...
                  style={{
                    ...
                    background: config.personality === p.id ? "#FAF6F2" : "#fff",
            ...
            <div style={{ marginBottom: "1.25rem", padding: "12px", background: "#F0FDFA", borderRadius: "12px", border: "1px solid #99F6E4" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                <div>
                  <div style={{ fontWeight: 800, fontSize: "0.85rem", color: "#0F766E" }}>
                    📲 Enviar Confirmação de Pedidos Automática pelo WhatsApp? (Marcado por padrão)
                  </div>
                  <div style={{ fontSize: "0.74rem", color: "#0F766E", marginTop: "2px" }}>
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  <button
                    ...
                    style={{
                      padding: "6px 14px", borderRadius: "8px", border: "none",
                      background: config.sendOrderConfirmation !== false ? "#0F766E" : "#E2E8F0",
            ...
            <div style={{ marginBottom: "1.25rem", padding: "14px", background: "linear-gradient(135deg, #FAF6F2, #FAF6F2)", borderRadius: "14px", border: "1.5px solid #E7DDD3" }}>
              <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", gap: "12px" }}>
                <div>
                  <div style={{ fontWeight: 800, fontSize: "0.9rem", color: "#1C1917", display: "flex", alignItems: "center", gap: "6px" }}>
                    🤖 Permitir que a IA anote e crie pedidos diretamente pelo WhatsApp?
                  </div>
                  <p style={{ fontSize: "0.76rem", color: "#1C1917", marginTop: "4px", lineHeight: "1.4" }}>
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  <button
                    ...
                    style={{
                      padding: "6px 14px", borderRadius: "8px", border: "none",
                      background: config.stopOnHumanRequest !== false ? "#0F766E" : "#E2E8F0",
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  <button
                    ...
                    style={{
                      padding: "6px 14px", borderRadius: "8px", border: "none",
                      background: config.acceptsPickup ? "#0F766E" : "#E2E8F0",
                ...
                <div style={{ display: "flex", gap: "6px" }}>
                  <button
                    ...
                    style={{
                      ...
                      background: config.storeType === "PHYSICAL" ? "#1C1917" : "#E2E8F0",
          ...
          <div style={{ background: "#075E54", color: "#fff", padding: "14px 16px", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
            <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
              ...
              <div>
                ...
                <div style={{ fontSize: "0.72rem", color: "#99F6E4", display: "flex", alignItems: "center", gap: "4px" }}>
                  <span style={{ width: 6, height: 6, borderRadius: "50%", background: "#5EEAD4" }} /> Online · Gemini 2.5
                </div>
              </div>
            </div>
          ...
          <div style={{ background: "#fff", borderRadius: "20px", width: "100%", maxWidth: "420px", padding: "1.5rem", boxShadow: "0 20px 40px rgba(0,0,0,0.2)" }}>
              ...
              <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr 1fr", gap: "6px" }}>
                <button
                  ...
                  style={{
                    ...
                    border: newCouponType === "percent" ? "2px solid #1C1917" : "1px solid #CBD5E1",
                    background: newCouponType === "percent" ? "#FAF6F2" : "#fff",
                    color: newCouponType === "percent" ? "#1C1917" : "#64748B",
                    fontWeight: 800, fontSize: "0.78rem", cursor: "pointer"
                  }}
                >
                  🏷️ Porcentagem (%)
                ...
                <button
                  ...
                  style={{
                    padding: "8px 4px", borderRadius: "10px", textAlign: "center",
                    border: newCouponType === "free_shipping" ? "2px solid #0F766E" : "1px solid #CBD5E1",
                    background: newCouponType === "free_shipping" ? "#F0FDFA" : "#fff",
                    color: newCouponType === "free_shipping" ? "#0F766E" : "#64748B",
                    fontWeight: 800, fontSize: "0.78rem", cursor: "pointer"
                  }}
                >
                  🚚 Frete Grátis
            ...
            <div style={{ marginBottom: "12px" }}>
              ...
              <input
                ...
                style={{ width: "100%", padding: "10px 12px", borderRadius: "10px", border: "1.5px solid #CBD5E1", fontSize: "0.9rem", fontWeight: 800, color: "#1C1917", boxSizing: "border-box" }}
              />
            </div>
            ...
            <div style={{ marginBottom: "1.25rem" }}>
              ...
              {newCouponType === "free_shipping" && (
                <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", padding: "12px 14px", borderRadius: "12px", display: "flex", alignItems: "center", gap: "10px" }}>
                  <span style={{ fontSize: "1.3rem" }}>🚚</span>
                  <div>
                    <div style={{ fontWeight: 800, color: "#0F766E", fontSize: "0.85rem" }}>Benefício de Frete Grátis</div>
                  </div>
                </div>
              )}
            </div>
            ...
            <div style={{ display: "flex", gap: "8px", justifyContent: "flex-end" }}>
              ...
              <button
                ...
                style={{ padding: "10px 20px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, #0F766E, #0F766E)", color: "#fff", fontWeight: 800, fontSize: "0.85rem", cursor: "pointer" }}
              >
      ...
      {showConfirmTestModal && (
        <div style={{ position: "fixed", inset: 0, background: "rgba(15, 23, 42, 0.65)", backdropFilter: "blur(6px)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999, padding: "1rem" }}>
          <div style={{ background: "#fff", borderRadius: "20px", width: "100%", maxWidth: "460px", padding: "1.75rem", boxShadow: "0 25px 50px -12px rgba(0,0,0,0.25)", border: "1px solid #E2E8F0", animation: "fadeIn 0.2s ease-out" }}>
            <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1rem" }}>
              <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                <div style={{ width: 42, height: 42, borderRadius: "12px", background: "#FFF4EF", color: "#E8590C", display: "flex", alignItems: "center", justifyContent: "center" }}>
                  <Send size={22} />
                </div>
                <div>
            ...
            <div style={{ background: "#F8FAFC", borderRadius: "12px", padding: "12px 14px", border: "1px solid #E2E8F0", marginBottom: "1.2rem" }}>
              ...
              <div style={{ fontSize: "1rem", fontWeight: 900, color: "#1C1917", display: "flex", alignItems: "center", gap: "6px" }}>
                📱 {testPhone}
              </div>
            </div>
            ...
            <div style={{ display: "flex", gap: "10px", justifyContent: "flex-end" }}>
              ...
              <button
                ...
                disabled={sendingTest}
                style={{ flex: 1.5, padding: "11px", borderRadius: "10px", border: "none", background: "linear-gradient(135deg, #E8590C, #9A3412)", color: "#fff", fontWeight: 900, fontSize: "0.88rem", cursor: "pointer", boxShadow: "0 4px 12px rgba(234, 88, 12, 0.25)" }}
              >
