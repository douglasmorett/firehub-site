      ...
      <div style={{ maxWidth: 1000, margin: "0 auto" }}>
        ...
        <div style={{ background: "#fff", borderRadius: "14px", padding: "16px 20px", marginBottom: "1rem", boxShadow: "0 2px 8px rgba(0,0,0,0.04)", border: "1px solid #F1F5F9" }}>
          <div style={{ display: "flex", justifyContent: "space-between", marginBottom: "8px" }}>
            ...
            <span style={{ fontSize: "0.82rem", color: semCustoCount > 0 ? "#B45309" : "#0F766E", fontWeight: 700 }}>
          ...
          <div style={{ height: "8px", background: "#F1F5F9", borderRadius: "999px", overflow: "hidden" }}>
            <div style={{
              ...
              background: preenchidos === products.length ? "#0F766E" : "#B45309",
        ...
        <div style={{ display: "flex", gap: "10px", flexWrap: "wrap", marginBottom: "1rem", alignItems: "center" }}>
          ...
          <button
            ...
            style={{
              ...
              border: filterSemCusto ? "none" : "1.5px solid #FDE68A",
            ...
            {prods.map((p, idx) => {
              ...
              return (
                <div key={p.id} style={{
                  ...
                  background: isSaved ? "#F0FDFA" : "transparent",
                  ...
                  {/* Preço */}
                  <div>
                    <span style={{ fontSize: "0.85rem", fontWeight: 700, color: "#0F766E" }}>{fmtR(p.price)}</span>
                  </div>
                    ...
                    <div style={{ display: "flex", alignItems: "center", gap: "4px" }}>
                      ...
                      <input
                        ...
                        style={{
                          ...
                          border: `1.5px solid ${custos[p.id] ? (parseFloat(custos[p.id]) > p.price ? "#C92E09" : "#0F766E") : "#E2E8F0"}`,
                          fontSize: "0.85rem", outline: "none", fontFamily: "inherit",
                          background: custos[p.id] ? "#F0FDFA" : "#F8FAFC",
                        }}
                      />
                    </div>
                    {custoVal > p.price && (
                  ...
                  <div>
                    {m ? (
                      <span style={{
                        ...
                        color: parseInt(m) < 20 ? "#C92E09" : parseInt(m) < 40 ? "#B45309" : "#0F766E",
                      }}>
                        {m}%
                      </span>
                    ) : (
                  ...
                  <div style={{ width: "24px" }}>
                    {isSaved && <CheckCircle size={16} color="#0F766E" />}
                  </div>
                </div>
              );
            })}
