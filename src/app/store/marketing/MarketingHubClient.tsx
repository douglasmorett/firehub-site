...
export default function MarketingHubClient() {
  ...
  const handleSaveAutomation = async () => {
    try {
      ...
      if (res.ok) {
        showToast("✅ Automações de Marketing salvas com sucesso!", "#0F766E");
      } else {
      ...
      >
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
          ...
          <div style={{ display: "flex", gap: "12px" }}>
            ...
            <div style={{ background: "rgba(255,255,255,0.1)", padding: "10px 16px", borderRadius: "12px", textAlign: "center" }}>
              <div style={{ fontSize: "1.2rem", fontWeight: 800, color: "#5EEAD4" }}>100% SEGURO</div>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "1fr 340px", gap: "1.5rem" }}>
          <div style={{ background: "#fff", padding: "1.5rem", borderRadius: "16px", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
            ...
            {DISPARO_EM_MASSA_LIBERADO ? (
              <div style={{ background: "#F0FDFA", padding: "16px", borderRadius: "12px", display: "flex", gap: "12px", border: "1px solid #99F6E4", color: "#0F766E", fontSize: "0.95rem" }}>
            ...
            <button
              ...
              style={{
                ...
                boxShadow: DISPARO_EM_MASSA_LIBERADO ? "0 4px 14px rgba(15, 118, 110, 0.3)" : "none",
                display: "flex",
                alignItems: "center",
                ...
                return (
                  <div
                    ...
                    style={{
                      ...
                      border: `1px solid ${isChecked ? "#99F6E4" : "#E2E8F0"}`,
                      cursor: "pointer",
                      display: "flex",
                      alignItems: "center",
                  ...
                  >
                    ...
                    <input type="checkbox" checked={isChecked} readOnly style={{ accentColor: "#0F766E" }} />
                  </div>
                );
              })}
            </div>
        ...
        <div style={{ background: "#fff", padding: "1.5rem", borderRadius: "16px", border: "1px solid #E2E8F0", boxShadow: "0 4px 6px -1px rgba(0,0,0,0.03)" }}>
          ...
          <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem", marginBottom: "1.5rem" }}>
            ...
            <div style={{ background: "#F8FAFC", padding: "1.25rem", borderRadius: "12px", border: "1px solid #E2E8F0" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 800, color: "#1E293B" }}>
                  <Flame size={18} color="#E8590C" /> 1º Incentivo — Cliente 7 Dias Sem Pedir
                </div>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    border: "none",
                    background: autoConfig.autoRecuperation7d ? "#0F766E" : "#CBD5E1",
                    color: "#fff",
                    fontWeight: 800,
                    fontSize: "0.75rem",
                    cursor: "pointer",
            ...
            <div style={{ background: "#F8FAFC", padding: "1.25rem", borderRadius: "12px", border: "1px solid #E2E8F0" }}>
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                <div style={{ display: "flex", alignItems: "center", gap: "8px", fontWeight: 800, color: "#1E293B" }}>
                  <Gift size={18} color="#1C1917" /> 2º Incentivo — Cliente 15 Dias Sem Pedir
                </div>
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    border: "none",
                    background: autoConfig.autoRecuperation15d ? "#0F766E" : "#CBD5E1",
                    color: "#fff",
                    fontWeight: 800,
                    fontSize: "0.75rem",
                    cursor: "pointer",
              ...
              <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "8px" }}>
                ...
                <button
                  ...
                  style={{
                    ...
                    borderRadius: "6px",
                    border: "none",
                    background: autoConfig.autoRecuperation30d ? "#0F766E" : "#CBD5E1",
                    color: "#fff",
                    fontWeight: 800,
                    fontSize: "0.75rem",
                    cursor: "pointer",
                ...
                {filteredCustomers.length === 0 ? (
                  ...
                  filteredCustomers.map((c) => (
                    <tr key={c.id} style={{ borderBottom: "1px solid #F1F5F9" }}>
                      ...
                      <td style={{ padding: "10px 14px", color: "#1C1917", fontWeight: 700 }}>{c.phone}</td>
