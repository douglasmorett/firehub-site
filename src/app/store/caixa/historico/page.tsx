      ...
      {sessions.length === 0 ? (
        ...
        return (
          <div key={s.id} style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 16, marginBottom: 12, overflow: "hidden", boxShadow: "0 2px 8px rgba(0,0,0,0.04)" }}>
            {/* Header */}
            <div style={{ background: ok ? "#F0FDFA" : "#FEF2F2", padding: "12px 16px", display: "flex", justifyContent: "space-between", alignItems: "center", flexWrap: "wrap", gap: 8 }}>
              ...
              <div style={{ textAlign: "right" }}>
                ...
                <div style={{ fontWeight: 900, fontSize: "1.1rem", color: ok ? "#0F766E" : "#C92E09" }}>
            ...
            {hasData && (
              <table style={{ width: "100%", borderCollapse: "collapse", fontSize: "0.83rem" }}>
                  ...
                  {[
                    ...
                    return (
                      <tr key={r.label} style={{ borderBottom: "1px solid #F1F5F9" }}>
                        ...
                        <td style={{ padding: "7px 16px", textAlign: "right", fontWeight: 700, color: Math.abs(d) < 0.01 ? "#0F766E" : d < 0 ? "#C92E09" : "#B45309" }}>
                ...
                <tfoot>
                  <tr style={{ background: ok ? "#F0FDFA" : "#FEF2F2" }}>
                    ...
                    <td style={{ padding: "8px 16px", textAlign: "right", fontWeight: 900, color: ok ? "#0F766E" : "#C92E09" }}>{fmt((s as any).closingCash + (s as any).closingDebit + (s as any).closingCredit + (s as any).closingPix + (s as any).closingVoucher || 0)}</td>
                    <td style={{ padding: "8px 16px", textAlign: "right", fontWeight: 900, color: ok ? "#0F766E" : diff < 0 ? "#C92E09" : "#B45309" }}>
