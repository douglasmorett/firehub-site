    ...
    <div style={{ padding: "32px", maxWidth: "1200px", margin: "0 auto", fontFamily: "Inter, sans-serif", color: "#0F172A" }}>
      ...
      {feedback && (
        <div style={{
          ...
          background: feedback.type === "success" ? "#0F766E" : "#C92E09",
      ...
      <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "32px" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "16px" }}>
          <span style={{ fontWeight: 600, color: store.totemEnabled ? "#0F766E" : "#64748B" }}>
          ...
          <button 
            ...
            style={{
              ...
              border: "none",
              background: store.totemEnabled ? "#FEE2E2" : "#0F766E",
          ...
          <div style={{ 
            ...
            <div style={{ 
              ...
              <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                <p style={{ margin: 0, fontSize: "28px", fontWeight: 800, color: onlineCount > 0 ? "#0F766E" : "inherit" }}>
                  {onlineCount}
                </p>
                  ...
                  <div key={t.id} style={{ 
                    ...
                    <div style={{ display: "flex", justifyContent: "space-between", alignItems: "flex-start" }}>
                      <div>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "6px", fontSize: "14px", fontWeight: 500, color: online ? "#0F766E" : "#64748B" }}>
                      ...
                      <span style={{ 
                        ...
                        background: t.active ? "#F0FDFA" : "#F1F5F9",
                        color: t.active ? "#0F766E" : "#64748B"
                      }}>
                    ...
                    <div style={{ display: "flex", gap: "8px", marginTop: "auto", flexWrap: "wrap" }}>
                      ...
                      >
                        <Power size={16} color={t.active ? "#64748B" : "#0F766E"} />
                      </button>
