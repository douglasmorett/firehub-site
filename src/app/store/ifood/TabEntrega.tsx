                  ...
                  <div style={{ display: "flex", justifyContent: "space-between", gap: 6 }}>
                    ...
                    {p.exigeCodigo && (
                      <span title="Este pedido exige código de entrega"
                        style={{ fontSize: "0.62rem", fontWeight: 800, color: "#475569", background: "#FAF6F2", padding: "1px 5px", borderRadius: 4 }}>
                        CÓDIGO
                      </span>
                    )}
                  </div>
                  ...
                  return (
                    <button key={etapa.chave}
                      ...
                      style={{
                        ...
                        border: `1.5px solid ${feita ? "#99F6E4" : proxima ? LARANJA : LINHA}`,
                        background: feita ? "#F0FDFA" : proxima ? "#fff" : "#F8FAFC",
                ...
                <>
                  ...
                  {resultadoCodigo && (
                    <div style={{
                      ...
                      background: resultadoCodigo.ok ? "#F0FDFA" : "#FEF2F2",
