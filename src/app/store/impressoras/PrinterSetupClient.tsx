...
export default function PrinterSetupClient({
  ...
  const selo =
    status === "connected"
      ? { texto: "Conectado", fundo: "#F0FDFA", cor: "#0F766E", borda: "#99F6E4" }
      : status === "checking"
    ...
    <div style={{ fontFamily: "'Inter',sans-serif", minHeight: "100vh", background: "#F8FAFC", padding: "2rem 1rem" }}>
      <div style={{ maxWidth: 680, margin: "0 auto" }}>
        ...
        <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", marginBottom: "1.5rem", flexWrap: "wrap", gap: 12 }}>
          ...
          <div style={{ display: "flex", gap: 10, flexWrap: "wrap" }}>
            ...
            <button
              onClick={saveConfig}
              disabled={saving}
              style={{ padding: "10px 24px", borderRadius: 12, background: saved ? "#0F766E" : "linear-gradient(135deg,#B71C1C,#C92E09)", color: "#fff", border: "none", fontWeight: 700, fontSize: "0.9rem", cursor: "pointer", fontFamily: "inherit", transition: "all 0.2s" }}
            >
        ...
        <div style={{ background: "#fff", borderRadius: 16, padding: "1.25rem 1.5rem", border: "1px solid #E2E8F0", marginBottom: "1.25rem", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
          <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
            <div style={{ width: 40, height: 40, borderRadius: 12, background: config.autoprint ? "#F0FDFA" : "#F8FAFC", border: `1.5px solid ${config.autoprint ? "#99F6E4" : "#E2E8F0"}`, display: "flex", alignItems: "center", justifyContent: "center" }}>
              <CheckCircle size={18} color={config.autoprint ? "#0F766E" : "#94A3B8"} />
            </div>
            <div>
          ...
          <button
            ...
            style={{ width: 52, height: 28, borderRadius: 14, background: config.autoprint ? "#0F766E" : "#E2E8F0", border: "none", cursor: "pointer", position: "relative", transition: "background 0.2s", flexShrink: 0 }}
          >
        ...
        <div style={{ background: "#fff", borderRadius: 16, padding: "1.25rem 1.5rem", border: "1.5px solid #E2E8F0", marginBottom: "1.25rem" }}>
          <div style={{ display: "flex", alignItems: "center", justifyContent: "space-between", gap: 16 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 12 }}>
              <div style={{ width: 40, height: 40, borderRadius: 12, background: (config.autoBeverageTag !== false) ? "#FAF6F2" : "#F8FAFC", border: `1.5px solid ${(config.autoBeverageTag !== false) ? "#E7DDD3" : "#E2E8F0"}`, display: "flex", alignItems: "center", justifyContent: "center", fontSize: "1.2rem" }}>
                🍹
              </div>
              <div>
            ...
            <button
              ...
              style={{ width: 52, height: 28, borderRadius: 14, background: (config.autoBeverageTag !== false) ? "#1C1917" : "#E2E8F0", border: "none", cursor: "pointer", position: "relative", transition: "background 0.2s", flexShrink: 0 }}
            >
        ...
        {config.printers.map((printer, idx) => (
          <div key={printer.id} style={{ background: "#fff", borderRadius: 16, padding: "1.25rem 1.5rem", border: "1px solid #E2E8F0", marginBottom: "1rem" }}>
            ...
            <div style={{ marginBottom: "1rem" }}>
              <button
                ...
                style={{
                  ...
                  border: printer.somenteBebidas ? "2px solid #1C1917" : "1.5px solid #E2E8F0",
                  background: printer.somenteBebidas ? "#FAF6F2" : "#fff",
                  color: printer.somenteBebidas ? "#1C1917" : "#64748B",
                }}
              >
            ...
            {printer.name && (
              <div style={{ background: "#FAF6F2", borderRadius: 12, padding: "0.85rem 1rem", border: "1px solid #E7DDD3", display: "flex", alignItems: "center", justifyContent: "space-between", gap: 12, marginTop: "1rem" }}>
                <div>
                  <p style={{ fontWeight: 700, fontSize: "0.82rem", margin: 0, color: "#1C1917" }}>🧪 Testar "{printer.label}"</p>
                  <p style={{ fontSize: "0.72rem", color: "#1C1917", margin: "2px 0 0" }}>Imprime uma comanda de teste</p>
                </div>
                <button
                  onClick={() => testPrint(printer.name, printer.label)}
                  disabled={testingPrinter === printer.name}
                  style={{ padding: "8px 16px", borderRadius: 10, background: "#1C1917", color: "#fff", border: "none", fontWeight: 700, fontSize: "0.8rem", cursor: "pointer", fontFamily: "inherit", whiteSpace: "nowrap", opacity: testingPrinter === printer.name ? 0.6 : 1 }}
                >
