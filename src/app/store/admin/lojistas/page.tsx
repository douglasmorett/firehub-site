  ...
  return (
    <div style={{ maxWidth: 1200, margin: "0 auto", padding: "1.5rem 1rem", fontFamily: "'Inter', sans-serif" }}>
      ...
      <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(150px, 1fr))", gap: "0.75rem", marginBottom: "1.5rem" }}>
        {[
          { label: "Total Lojistas", value: totalLojistas, color: "#1D4ED8", icon: "🏪" },
          { label: "Em Trial / Benefício", value: emTrial, color: "#B45309", icon: "🎁" },
          { label: "Assinantes", value: ativos, color: "#15803D", icon: "✅" },
                  ...
                  <tr key={l.id} style={{ borderBottom: "1px solid #F1F5F9" }}>
                    ...
                    <td style={{ padding: "10px 12px" }}>
                      {l.isFranqueadoHakim ? (
                        ...
                        <span style={{ background: "#ECFDF3", color: "#15803D", padding: "3px 8px", borderRadius: 6, fontWeight: 700, fontSize: "0.75rem" }}>
                          ✅ Ativo
                        </span>
                      )}
                    </td>
                    ...
                    <td style={{ padding: "10px 12px" }}>
                      <div style={{ display: "flex", gap: 6, alignItems: "center", flexWrap: "wrap" }}>
                        {l.slug && (
                          <a href={`/loja/${l.slug}`} target="_blank" style={{ fontSize: "0.75rem", color: "#1D4ED8", fontWeight: 600, textDecoration: "none" }} title="Ver loja">🔗 Cardápio</a>
                        )}
