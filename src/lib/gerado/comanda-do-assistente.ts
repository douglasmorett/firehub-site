 ...
 * (firehub-print-assistant/server.js, versão 1.2.23), copiado para a prévia
...
export const VERSAO_DO_ASSISTENTE = "1.2.23";
export const ASSINATURA_DO_CODIGO = "d47f44169c8a3da1";

/** Os bytes ESC/POS da comanda, como o Assistente 1.2.23 manda para a impressora. */
