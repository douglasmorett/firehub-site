            ...
            <tbody>
              {ambassadors.map(amb => (
                ...
                <tr style={{ borderBottom: "1px solid #E2E8F0" }}>
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <span style={{ background: "#F0FDFA", color: "#0F766E", padding: "4px 8px", borderRadius: "6px", fontWeight: 700, fontSize: "0.85rem" }}>
                      {amb.commissionPercent}% recorrente
                    </span>
                    {amb.asaasWalletId && <div style={{ fontSize:"0.75rem", color:"#1C1917", marginTop:4 }}>Asaas Split Ativo</div>}
                  ...
                  <td style={{ padding: "12px 16px" }}>
                    <span style={{ 
                      background: amb.active ? "#F0FDFA" : "#FEE2E2", 
                      color: amb.active ? "#0F766E" : "#B71C1C", 
                  ...
                  <td style={{ padding: "12px 16px", display: "flex", gap: "8px", flexWrap: "wrap" }}>
                    ...
                    <button 
                      ...
                      style={{ background: "#FAF6F2", color: "#1C1917", border: "1px solid #E7DDD3", padding: "6px 10px", borderRadius: "6px", cursor: "pointer", fontSize: "0.8rem", fontWeight: 600 }}
                    >
                      Editar
                    </button>
                    <button 
      ...
      {promoteStore && (
        <div style={{ position: "fixed", top: 0, left: 0, right: 0, bottom: 0, background: "rgba(0,0,0,0.5)", display: "flex", alignItems: "center", justifyContent: "center", zIndex: 9999 }}>
          <div style={{ background: "#FFF", width: "100%", maxWidth: "520px", borderRadius: "12px", padding: "24px", boxShadow: "0 10px 25px rgba(0,0,0,0.2)" }}>
            {promoteResult ? (
              <>
                <h3 style={{ fontSize: "1.2rem", fontWeight: 800, marginBottom: "8px", color: "#0F766E" }}>
