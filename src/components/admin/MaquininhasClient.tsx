    ...
    <div style={{ background: "#fff", borderRadius: 16, padding: 24, marginTop: 24, border: "1px solid #E2E8F0" }}>
      ...
      {aviso && (
        <div style={{
          ...
          background: aviso.erro ? "#FEF2F2" : "#F0FDFA",
          color: aviso.erro ? "#B71C1C" : "#0F766E",
          border: `1px solid ${aviso.erro ? "#FECACA" : "#99F6E4"}`,
        }}>{aviso.texto}</div>
      )}
              ...
              <div style={{ display: "flex", gap: 8, alignItems: "center" }}>
                {m.pareado && m.online && (
                  <span style={{
                    ...
                    color: "#0F766E", background: "#F0FDFA", padding: "4px 10px", borderRadius: 20,
