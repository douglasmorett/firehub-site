    ...
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem" }}>
      ...
      <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E2E8F0", boxShadow: "0 1px 6px rgba(0,0,0,0.05)", overflow: "hidden" }}>
        <div style={{ padding: "1rem 1.25rem", borderBottom: "1px solid #F1F5F9", display: "flex", alignItems: "center", gap: 8 }}>
          ...
          {isSecondaryAccount ? (
            ...
            <span style={{ marginLeft: "auto", display: "flex", alignItems: "center", gap: 4, fontSize: "0.8rem", color: "#15803D", fontWeight: 700 }}>
      ...
      <div style={{ background: "#fff", borderRadius: 16, border: "1px solid #E2E8F0", boxShadow: "0 1px 6px rgba(0,0,0,0.05)", overflow: "hidden" }}>
        ...
        <div style={{ padding: "1.25rem" }}>
          {passSuccess && (
            <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#ECFDF3", border: "1px solid #ABEFC6", color: "#15803D", padding: "10px 14px", borderRadius: 10, marginBottom: "1rem", fontWeight: 700, fontSize: "0.88rem" }}>
