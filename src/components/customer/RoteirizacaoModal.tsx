...
export default function RoteirizacaoModal({
  ...
  // Parser e limpeza de endereço vivem em lib/geocodificacao.ts (testáveis
  // fora do navegador). Aqui só a amarração com a cidade da loja.
  const parseAddressDetails = (rawAddr: string) => parseEnderecoDaEntrega(rawAddr, storeCity);
  ...
  useEffect(() => {
    ...
    deliveryOrders.forEach((order, idx) => {
      ...
      const dictFallback = dicionarioDeBairro(neighborhood, defaultCenter);
    ...
    const geocodeAddresses = async () => {
      ...
      // aviso vazio: em 26/08 o IP da loja estava tomando 429 em TODA busca.
      ...
      for (let i = 0; i < faltam.length; i += BATCH_SIZE) {
        ...
        await Promise.all(
          batch.map(async (item) => {
            const { coords, origem } = await geo.geocodificarItem(item);
            console.log(`[Roteirização] ${item.neighborhood || "(sem bairro)"} · ${item.streetName || "(sem rua)"} → ${origem}`);
  ...
  useEffect(() => {
    ...
    if (temPontoDaLoja) {
      const storeHtml = `
        <div style="
          background: #1D4ED8; color: #fff; width: 38px; height: 38px; borderRadius: 50%;
    ...
    deliveryOrders.forEach(order => {
      ...
      let bgColor = recemEntregue ? "#15803D" : jaDespachado ? "#1D4ED8" : prontoNaCozinha ? "#475569" : "#C92E09";
      ...
      if (isHovered) {
        ...
        bgColor = "#1D4ED8"; // Bright blue for active route selection
        labelText = `${selectedIndex + 1}`; // Sequence 1, 2, 3
        borderColor = "#B2DDFF";
        scaleCss = "scale(1.2)";
        zIdx = 900;
      } else if (assignedRoute) {
        bgColor = assignedRoute.color || "#15803D"; // Route specific color
        borderColor = "#ffffff";
        zIdx = 500;
      }
    ...
    (mostrarMotoboys ? motoboys : []).forEach(mb => {
      ...
      const corCapacete = !recente ? "#94A3B8" : emEntrega ? "#C92E09" : "#15803D";
      const corNome = !recente ? "#64748B" : emEntrega ? "#B71C1C" : "#15803D";
      ...
      const mbMarker = L.marker([mbLat, mbLng], { icon: mbIcon, zIndexOffset: 950 })
        .addTo(map)
        .bindPopup(`<b>🛵 Entregador ${mb.name}</b> <span style="color:${emEntrega ? "#B71C1C" : "#15803D"};font-weight:700;">${emEntrega ? `${entregasNaRua} entrega(s) na rua` : "livre"}</span><br/>📍 ${
      ...
      <div style={{
        ...
        <div style={{
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "1rem" }}>
            <div style={{ background: "#EFF6FF", color: "#1D4ED8", padding: "8px 12px", borderRadius: "10px", display: "flex", alignItems: "center", gap: 8, fontWeight: 800 }}>
              <MapPin size={20} />
          ...
          <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
            {!modoIndependente && (
              <a
                ...
                style={{
                  padding: "8px 14px", background: "#ECFDF3", border: "1px solid #ABEFC6",
            ...
            <button
              ...
              style={{
                padding: "8px 14px", background: "#EFF6FF", border: "1px solid #B2DDFF",
            ...
            <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", borderBottom: "2px solid #E2E8F0" }}>
              <button
                ...
                style={{
                  ...
                  borderBottom: activeTab === "PENDING" ? "3px solid #1D4ED8" : "none",
                  fontWeight: 800, fontSize: "0.88rem", color: activeTab === "PENDING" ? "#1D4ED8" : "#64748B",
              ...
              <button
                ...
                style={{
                  ...
                  borderBottom: activeTab === "ROTAS" ? "3px solid #1D4ED8" : "none",
                  fontWeight: 800, fontSize: "0.88rem", color: activeTab === "ROTAS" ? "#1D4ED8" : "#64748B",
                  cursor: "pointer", transition: "all 0.2s"
                }}
              >
              ...
              <div style={{ flex: 1, display: "flex", flexDirection: "column", overflow: "hidden" }}>
                ...
                <div style={{ padding: "0.75rem 1rem", borderBottom: "1px solid #F1F5F9", display: "flex", flexDirection: "column", gap: "0.6rem" }}>
                  ...
                  <div style={{ display: "flex", gap: "4px", background: "#F1F5F9", padding: "4px", borderRadius: "10px", border: "1px solid #E2E8F0" }}>
                    ...
                    <button
                      ...
                      style={{
                        flex: 1, padding: "6px 10px", borderRadius: "7px", border: "none",
                        background: onlyProntoOrders ? "linear-gradient(135deg, #15803D, #15803D)" : "transparent",
                    ...
                    filteredPendingOrders.map((order) => {
                      ...
                      return (
                        <div
                          ...
                          style={{
                            border: isHovered ? "2px solid #1D4ED8" : isSelected ? "2px solid #1D4ED8" : "1px solid #E2E8F0",
                        ...
                        >
                          <div style={{ display: "flex", alignItems: "flex-start", gap: "0.75rem" }}>
                            ...
                            <div style={{
                              ...
                              background: isSelected ? "linear-gradient(135deg, #1D4ED8, #1D4ED8)" : "#F1F5F9",
                                ...
                                return (
                                  <div style={{ margin: "3px 0 5px 0" }}>
                                    <div style={{ display: "flex", alignItems: "center", gap: 6, marginBottom: 3, flexWrap: "wrap" }}>
                                      ...
                                      {!isMapped && (
                                        <span style={{
                                          background: "#EFF6FF", color: "#1D4ED8", border: "1px solid #B2DDFF",
                ...
                <div style={{ padding: "0.75rem 1rem", borderTop: "1px solid #E2E8F0", background: "#F8FAFC" }}>
                  <div style={{ fontSize: "0.75rem", color: "#64748B", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                    ...
                    <span style={{ fontWeight: 800, color: "#15803D" }}>ILIMITADO</span>
                  </div>
                </div>
                  ...
                  createdRoutes.map(route => {
                    ...
                    return (
                      <div
                        key={route.id}
                        style={{
                          border: isDispatched ? "1.5px solid #ABEFC6" : "1.5px solid #FED7AA",
                          background: isDispatched ? "#ECFDF3" : "#FFF7E6",
                      ...
                      >
                        <div style={{ display: "flex", alignItems: "flex-start", justifyContent: "space-between", marginBottom: "0.5rem" }}>
                          ...
                          <span style={{
                            fontSize: "0.74rem",
                            color: isDispatched ? "#15803D" : "#B45309",
                            fontWeight: 900,
                            background: isDispatched ? "#ECFDF3" : "#FFF7E6",
                            padding: "3px 8px",
                            borderRadius: "6px",
                            border: isDispatched ? "1px solid #ABEFC6" : "1px solid #FDE68A",
                          }}>
                        ...
                        <div style={{ display: "flex", alignItems: "center", gap: "0.5rem" }}>
                          {!isDispatched && (
                            <button
                              ...
                              style={{
                                ...
                                borderRadius: "8px", background: "linear-gradient(135deg, #15803D, #15803D)",
                          ...
                          <button
                            ...
                            style={{
                              flex: 1, padding: "8px", border: "1.5px solid #1D4ED8",
                              borderRadius: "8px", background: copiedRouteId === route.id ? "#ECFDF3" : "#FFFFFF",
                              color: copiedRouteId === route.id ? "#15803D" : "#1D4ED8",
          ...
          <div style={{ flex: 1, height: "100%", position: "relative" }}>
            ...
            <div style={{
              ...
              <div style={{ display: "flex", gap: "8px" }}>
                ...
                >
                  <Navigation size={15} style={{ transform: "rotate(45deg)", color: "#1D4ED8" }} />
                  Centralizar Visão
                </button>
            ...
            <div style={{
              ...
              {([
                ...
                { chave: "rota" as const, cor: "#1D4ED8", rotulo: "Saiu para entrega" },
                { chave: "entregue" as const, cor: "#15803D", rotulo: "Entregue agora" },
              ]).map((e) => {
              ...
              <div style={{
                ...
                {selectedOrderIds.length > 1 && (
                  <button
                    ...
                    style={{
                      background: "linear-gradient(135deg, #15803D, #15803D)", color: "#FFFFFF", border: "none",
      ...
      {showDispatchModal && (
        <div style={{
          ...
          <div style={{
                  ...
                  return (
                    <div key={id} style={{ fontSize: "0.8rem", color: "#1E293B", display: "flex", alignItems: "center", justifyContent: "space-between" }}>
                      <div style={{ display: "flex", alignItems: "center", gap: 6 }}>
                        <span style={{ background: "#1D4ED8", color: "#fff", width: "18px", height: "18px", borderRadius: "50%", fontSize: "0.7rem", fontWeight: 900, display: "inline-flex", alignItems: "center", justifyContent: "center" }}>
                          {idx + 1}
                        </span>
                        <b>#{o.orderNumber || o.displayId || o.id.slice(-4)}</b> — {o.customerName} ({o.neighborhood || "Centro"})
                      </div>
                      <span style={{ fontSize: "0.72rem", fontWeight: 700, color: pInfo.isCash ? "#C92E09" : pInfo.isCardOnDelivery ? "#1D4ED8" : "#15803D" }}>
            ...
            <div style={{ background: "#ECFDF3", border: "1.5px solid #ABEFC6", borderRadius: "10px", padding: "0.85rem", marginBottom: "1.25rem" }}>
              <div style={{ fontSize: "0.78rem", fontWeight: 900, color: "#15803D", marginBottom: "0.4rem", display: "flex", alignItems: "center", gap: "6px" }}>
              ...
              <div style={{ display: "flex", flexDirection: "column", gap: "0.35rem", fontSize: "0.82rem", color: "#15803D" }}>
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <b style={{ fontSize: "0.95rem", color: routePaymentSummary.totalChangeToCarry > 0 ? "#C92E09" : "#15803D" }}>
                ...
                <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center" }}>
                  ...
                  <b style={{ color: routePaymentSummary.needsCardMachine ? "#1D4ED8" : "#475569" }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "0.75rem" }}>
              ...
              <button
                ...
                disabled={isDispatching}
                style={{
                  flex: 2, padding: "10px", background: "#1D4ED8", border: "none",
          ...
          <div style={{
            ...
            <div style={{ display: "flex", flexDirection: "column", gap: "1.1rem" }}>
              ...
              <div>
                ...
                <select
                  ...
                  style={{
                    width: "100%", padding: "10px", borderRadius: "8px", border: "1.5px solid #1D4ED8",
                ...
                <>
                  ...
                  <div>
                    ...
                    <select
                      ...
                      style={{ width: "100%", padding: "8px 12px", borderRadius: "8px", border: "1.5px solid #1D4ED8", background: "#EFF6FF", fontWeight: 800, color: "#1D4ED8" }}
                    >
                ...
                <>
                  <div>
                    ...
                    <input
                      ...
                      style={{ width: "100%", padding: "8px 12px", borderRadius: "8px", border: "1.5px solid #B2DDFF", background: "#EFF6FF", fontWeight: 800 }}
                    />
                  </div>
            ...
            <div style={{
              ...
              <button
                ...
                style={{
                  padding: "10px 20px", background: "#1D4ED8", color: "#FFFFFF",
