    ...
    <div style={{ fontFamily: "'Inter', sans-serif" }}>
      ...
      {method === "pix" && pixData && !pixPaid && !pixExpired && (
        <div style={{ textAlign: "center" }}>
          <div style={{ background: "#F0FDFA", border: "2px solid #99F6E4", borderRadius: "16px", padding: "20px", marginBottom: "12px" }}>
            <p style={{ fontSize: "0.82rem", fontWeight: 700, color: "#0F766E", marginBottom: "12px" }}>
      ...
      {pixPaid && (
        <div style={{ textAlign: "center", padding: "1.5rem 0" }}>
          <div style={{ width: 64, height: 64, borderRadius: "50%", background: "#0F766E", display: "flex", alignItems: "center", justifyContent: "center", margin: "0 auto 16px" }}>
            <Check size={36} color="#fff" />
          </div>
          <h3 style={{ fontWeight: 800, color: "#0F766E", fontSize: "1.2rem", marginBottom: "6px" }}>
