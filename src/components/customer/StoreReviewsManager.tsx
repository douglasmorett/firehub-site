  ...
  return (
    <div style={{ display: "flex", flexDirection: "column", gap: "1.25rem", fontFamily: "sans-serif" }}>
      ...
      <div style={{ background: "#FFFFFF", borderRadius: 18, padding: "1.25rem 1.5rem", border: "1px solid #E2E8F0", boxShadow: "0 2px 8px rgba(0,0,0,0.03)", display: "flex", alignItems: "center", justifyContent: "space-between", flexWrap: "wrap", gap: "1rem" }}>
        ...
        <button
          ...
          style={{
            ...
            background: showOnMenu ? "#0F766E" : "#64748B", color: "#FFFFFF",
            fontWeight: 800, fontSize: "0.88rem", cursor: "pointer",
            boxShadow: showOnMenu ? "0 4px 12px rgba(15, 118, 110,0.25)" : "none",
      ...
      <div style={{ background: "#FAF6F2", borderRadius: 16, padding: "1rem 1.25rem", border: "1px solid #E7DDD3", display: "flex", alignItems: "flex-start", gap: 12 }}>
        <Info size={20} color="#1C1917" style={{ marginTop: 2, flexShrink: 0 }} />
        <div style={{ fontSize: "0.83rem", color: "#1C1917", lineHeight: 1.5 }}>
              ...
              return (
                <div key={starNum} style={{ display: "flex", alignItems: "center", gap: 8, fontSize: "0.8rem" }}>
                  ...
                  <div style={{ flex: 1, height: 8, background: "#F1F5F9", borderRadius: 4, overflow: "hidden" }}>
                    <div style={{ height: "100%", width: `${pct}%`, background: starNum >= 4 ? "#0F766E" : starNum === 3 ? "#B45309" : "#C92E09", borderRadius: 4 }} />
                  </div>
            ...
            {filteredReviews.map((r) => {
              ...
              return (
                <div key={r.id} style={{ background: "#F8FAFC", borderRadius: 14, padding: "1rem 1.25rem", border: "1px solid #E2E8F0" }}>
                  ...
                  {r.reply && (
                    <div style={{ background: "#FAF6F2", borderRadius: 10, padding: "8px 12px", borderLeft: "4px solid #1C1917", marginTop: 8, fontSize: "0.82rem" }}>
                      <span style={{ fontWeight: 800, color: "#1C1917" }}>💬 Resposta da Loja:</span>
                      <p style={{ margin: "2px 0 0", color: "#1C1917" }}>{r.reply}</p>
                    </div>
                  )}
                    ...
                    {replyingId === r.id ? (
                      <div style={{ marginTop: 8, display: "flex", flexDirection: "column", gap: 6 }}>
                        <textarea
                          ...
                          style={{ width: "100%", padding: "8px 12px", borderRadius: 8, border: "1.5px solid #1C1917", fontSize: "0.82rem", fontFamily: "inherit" }}
                        />
                        <div style={{ display: "flex", gap: 6, justifyContent: "flex-end" }}>
                          ...
                          <button
                            ...
                            style={{ padding: "6px 14px", borderRadius: 8, border: "none", background: "#1C1917", color: "#FFFFFF", fontWeight: 800, fontSize: "0.78rem", cursor: "pointer", display: "flex", alignItems: "center", gap: 4 }}
                          >
                      ...
                      <button
                        ...
                        style={{ background: "transparent", border: "none", color: "#1C1917", fontWeight: 700, fontSize: "0.78rem", cursor: "pointer", display: "inline-flex", alignItems: "center", gap: 4, padding: 0 }}
                      >
