...
export default function TrafegoPagoPage({ user }: { user: any }) {
  ...
  const Banner = () => {
    ...
    const cfg = {
      success: { bg: "#F0FDFA", border: "#99F6E4", color: "#0F766E", Icon: CheckCircle },
      error: { bg: "#FEF2F2", border: "#FECACA", color: "#B71C1C", Icon: AlertTriangle },
      info: { bg: "#FAF6F2", border: "#E7DDD3", color: "#1C1917", Icon: Zap },
    }[notification.type];
    return (
  ...
  if (loading) return (
    <div style={{ display: "flex", alignItems: "center", justifyContent: "center", height: "60vh" }}>
      <div style={{ textAlign: "center" }}>
        <div style={{ width: 48, height: 48, border: "4px solid #E2E8F0", borderTopColor: "#1C1917", borderRadius: "50%", animation: "spin 0.8s linear infinite", margin: "0 auto 16px" }} />
    ...
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 1rem 4rem" }}>
      ...
      <div className="hero-steps-grid" style={{ display: "grid", gridTemplateColumns: "repeat(3,1fr)", gap: "1rem", marginBottom: "2rem" }}>
        {[
          ...
          { step: "2", emoji: "💰", title: "Escolha o investimento", desc: "A partir de R$100/semana. Você decide.", color: "#0F766E" },
        ...
        <div className="social-track">
          {[...SOCIAL_PROOF, ...SOCIAL_PROOF].map((r, i) => (
            <div key={i} style={{ flexShrink: 0, background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: "0.85rem 1rem", minWidth: 200 }}>
              ...
              <div style={{ fontSize: "0.78rem", color: "#64748B" }}>Investiu <strong>R${r.invested}</strong> — Faturou <span style={{ color: "#0F766E", fontWeight: 800 }}>R${r.earned.toLocaleString("pt-BR")}</span></div>
            </div>
          ))}
        </div>
      </div>
      ...
      <div className="hero-live-row" style={{ display: "flex", justifyContent: "center", gap: "3rem", borderTop: "1px solid #E2E8F0", paddingTop: "1.5rem" }}>
        {[
          ...
          <div key={s.label} style={{ textAlign: "center" }}>
            <div style={{ fontSize: "1.3rem", fontWeight: 900, color: "#0F766E", fontVariantNumeric: "tabular-nums", transition: "all 0.3s ease" }}>{s.value}</div>
  ...
  if (step === "invest") return (
    <div style={{ maxWidth: 500, margin: "0 auto", padding: "0 1rem 4rem" }}>
        ...
        <div style={{ display: "flex", flexWrap: "wrap", gap: 6, justifyContent: "center", marginBottom: "1.25rem" }}>
          {BUDGET_PRESETS.map(v => (
            <button key={v} onClick={() => setInvestment(v)}
              ...
              R${v}
              {v === 150 && <span style={{ position: "absolute", top: -8, right: -4, background: "#0F766E", color: "#fff", fontSize: "0.55rem", fontWeight: 800, padding: "1px 5px", borderRadius: 6, whiteSpace: "nowrap" }}>⭐ Popular</span>}
            </button>
          ))}
        </div>
      ...
      {/* Estimativas */}
      <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: 12, padding: "1rem", marginBottom: "0.75rem" }}>
        <div style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.5rem", textAlign: "center" }}>
          ...
          <div>
            ...
            <div style={{ fontSize: "1.3rem", fontWeight: 900, color: "#1C1917" }}>≈ {(investment * 85).toLocaleString("pt-BR")}</div>
        ...
        <div style={{ fontSize: "0.68rem", color: "#94A3B8", marginTop: 8, lineHeight: 1.4, borderTop: "1px solid #99F6E4", paddingTop: 8, textAlign: "center" }}>
  ...
  if (step === "connect") return (
    <div style={{ maxWidth: 480, margin: "0 auto", padding: "0 1rem 4rem" }}>
      ...
      <div style={{ background: "#fff", border: "1.5px solid #E2E8F0", borderRadius: 16, padding: "1.5rem" }}>
        ...
        <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: 10, padding: "0.6rem 0.85rem", marginBottom: "1rem", fontSize: "0.82rem", color: "#0F766E", fontWeight: 600 }}>
  ...
  if (step === "creative") return (
    <div style={{ maxWidth: 700, margin: "0 auto", padding: "0 1rem 4rem" }}>
      ...
      {/* ── Resumo + Publicar ── */}
      <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: 12, padding: "1rem", marginBottom: "1rem", fontSize: "0.85rem" }}>
        ...
        <div style={{ display: "flex", justifyContent: "space-between", borderTop: "1px solid #99F6E4", paddingTop: 8, marginTop: 4 }}><span style={{ fontWeight: 700 }}>Total semanal:</span><strong style={{ color: "#0F766E" }}>R$ {investment + 50}</strong></div>
        ...
        <div style={{ fontSize: "0.75rem", color: "#0F766E", marginTop: 8, lineHeight: 1.5, borderTop: "1px solid #99F6E4", paddingTop: 8 }}>
          Ao publicar, os R$ 50 de gestão desta semana entram na sua fatura.{" "}
          <button type="button" onClick={() => setStep("invest")}
            style={{ background: "none", border: "none", padding: 0, color: "#0F766E", fontWeight: 800, textDecoration: "underline", cursor: "pointer", fontSize: "0.75rem", fontFamily: "inherit" }}>
  ...
  return (
    <div style={{ maxWidth: 900, margin: "0 auto", padding: "0 1rem 4rem" }}>
      ...
      <div className="dash-kpis" style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit,minmax(155px,1fr))", gap: "0.75rem", marginBottom: "1rem" }}>
        {[
          { label: "Total investido", value: `R$ ${totalSpend.toLocaleString("pt-BR", { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`, color: "#1C1917", icon: DollarSign },
          { label: "Pedidos gerados", value: totalOrders.toLocaleString("pt-BR"), color: "#0F766E", icon: CheckCircle },
      ...
      {totalSpend > 0 && (
        <div style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 12, padding: "1rem", marginBottom: "1.5rem" }}>
          <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
            ...
            <span style={{ fontSize: "0.82rem", fontWeight: 800, color: roasNum >= 2 ? "#0F766E" : roasNum >= 1 ? "#B45309" : "#C92E09" }}>
          ...
          <div style={{ background: "#F1F5F9", borderRadius: 8, height: 12, overflow: "hidden", position: "relative" }}>
            <div style={{
              ...
              background: roasNum >= 2 ? "linear-gradient(90deg,#0F766E,#0F766E)" : roasNum >= 1 ? "linear-gradient(90deg,#B45309,#B45309)" : "linear-gradient(90deg,#C92E09,#C92E09)",
      ...
      {contaMeta?.conectado && (
        <div style={{
          background: contaMeta.pronto ? "#F0FDFA" : "#FEF2F2",
          border: `1.5px solid ${contaMeta.pronto ? "#99F6E4" : "#FCA5A5"}`,
              ...
              {contaMeta.carteira ? (
                <>
                  ...
                  {contaMeta.carteira.cobrancaAutomatica ? (
                    <>
                      <div style={{ fontSize: "1.25rem", fontWeight: 900, color: "#0F766E" }}>
                    ...
                    <>
                      <div style={{ fontSize: "1.6rem", fontWeight: 900, color: contaMeta.pronto ? "#0F766E" : "#B71C1C" }}>
                      ...
                      <div style={{ fontSize: "0.72rem", color: contaMeta.pronto ? "#0F766E" : "#B71C1C" }}>
                ...
                <>
                  ...
                  <div style={{ fontSize: "1.05rem", fontWeight: 900, color: contaMeta.pronto ? "#0F766E" : "#B71C1C", lineHeight: 1.35 }}>
          ...
          {!contaMeta.carteira?.cobrancaAutomatica && contaMeta.pronto && (
            <div style={{ fontSize: "0.72rem", color: "#64748B", marginTop: 8, lineHeight: 1.5, borderTop: "1px solid #99F6E4", paddingTop: 8 }}>
          ...
          {contasDisponiveis.length > 1 && (
            <div style={{ marginTop: 12, borderTop: `1px solid ${contaMeta.pronto ? "#99F6E4" : "#FCA5A5"}`, paddingTop: 10 }}>
          ...
          return (
            <div key={c.id} style={{ background: "#fff", border: "1px solid #E2E8F0", borderRadius: 14, padding: "1.25rem", marginBottom: "0.75rem" }}>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem", flexWrap: "wrap", gap: 8 }}>
                <div style={{ display: "flex", alignItems: "center", gap: 10 }}>
                  ...
                  <div>
                    <div style={{ fontWeight: 700, fontSize: "0.9rem", display: "flex", alignItems: "center", gap: 6 }}>
                      ...
                      <span style={{ background: "#FAF6F2", border: "1px solid #E7DDD3", padding: "1px 6px", borderRadius: 5, fontSize: "0.6rem", fontWeight: 700, color: "#1C1917", display: "inline-flex", alignItems: "center", gap: 3 }}>
                        <Bot size={9} /> IA
                      </span>
                    </div>
                ...
                <div style={{ display: "flex", gap: 6, alignItems: "center" }}>
                  <span style={{
                    ...
                    background: isActive ? "#F0FDFA" : isPaused ? "#FFF7E6" : "#F1F5F9",
                    color: isActive ? "#0F766E" : isPaused ? "#92400E" : "#475569",
                    border: `1px solid ${isActive ? "#99F6E4" : isPaused ? "#FDE68A" : "#E2E8F0"}`,
                  }}>
                  ...
                  {isActive && (
                    <button onClick={() => handleAction(c.id, "pause")} disabled={actionLoading}
                      style={{ background: "#FFF7E6", border: "1px solid #FDE68A", borderRadius: 8, padding: "6px 12px", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", color: "#92400E", display: "flex", alignItems: "center", gap: 4 }}>
                  ...
                  {isPaused && (
                    ...
                    <button onClick={() => confirmarRetomada(c)} disabled={actionLoading}
                      style={{ background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: 8, padding: "6px 12px", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", color: "#0F766E", display: "flex", alignItems: "center", gap: 4 }}>
                  ...
                  {isEncerrada && (
                    <button
                      ...
                      style={{ background: "#FAF6F2", border: "1px solid #E7DDD3", borderRadius: 8, padding: "6px 12px", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", color: "#1C1917", display: "flex", alignItems: "center", gap: 4 }}>
                  ...
                  {editingBudget === c.id ? (
                    <div style={{ display: "flex", gap: 4, alignItems: "center" }}>
                      ...
                      <button onClick={() => handleAction(c.id, "update_budget", { weeklyBudget: newBudget })} disabled={actionLoading}
                        style={{ background: "#FAF6F2", border: "1px solid #E7DDD3", borderRadius: 8, padding: "4px 8px", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", color: "#1C1917" }}>
                        Salvar
                      </button>
                    ...
                    <button onClick={() => { setEditingBudget(c.id); setNewBudget(c.weeklyBudget || 100); }} disabled={actionLoading}
                      ...
                      style={{ background: "#FAF6F2", border: "1px solid #E7DDD3", borderRadius: 8, padding: "4px 10px", fontSize: "0.72rem", fontWeight: 700, cursor: "pointer", color: "#1C1917" }}>
              ...
              <div className="dash-campaign-metrics" style={{ display: "grid", gridTemplateColumns: "repeat(5,1fr)", gap: "0.5rem" }}>
                {[
                  { label: "Investido", value: `R$ ${spend.toFixed(2)}`, color: "#1C1917" },
                  ...
                  { label: "Pedidos", value: orders.toString(), color: "#0F766E" },
              ...
              {orders > 0 && (
                <div style={{ marginTop: 8, display: "flex", gap: "1rem", fontSize: "0.78rem", color: "#64748B" }}>
                  ...
                  {revenue > spend && <span>💚 Lucro estimado: <strong style={{ color: "#0F766E" }}>R$ {(revenue - spend).toFixed(2)}</strong></span>}
                </div>
              )}
      ...
      <div className="dash-info-grid" style={{ display: "grid", gridTemplateColumns: "1fr 1fr", gap: "0.75rem" }}>
        <div style={{ background: "#FAF6F2", border: "1px solid #E7DDD3", borderRadius: 12, padding: "1rem" }}>
          <div style={{ fontSize: "0.82rem", color: "#1C1917", fontWeight: 700, marginBottom: 6 }}>💰 Taxa de gestão (serviço)</div>
          <div style={{ fontSize: "0.78rem", color: "#1C1917" }}>
        ...
        <div style={{ background: "#F0FDFA", border: "1px solid #99F6E4", borderRadius: 12, padding: "1rem" }}>
          <div style={{ fontSize: "0.82rem", color: "#0F766E", fontWeight: 700, marginBottom: 6 }}>🤖 Tudo automático</div>
