...
export default function StoreTeamManager() {
  ...
  function showToast(text: string, bg: string = "#0F766E") {
    setToastMsg({ text, bg });
        ...
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "20px", flexWrap: "wrap", gap: "12px" }}>
          <div>
            <h2 style={{ fontSize: "1.35rem", fontWeight: 800, color: "#0F172A", margin: 0, display: "flex", alignItems: "center", gap: "8px" }}>
              <Users size={22} color="#1C1917" /> Equipe da Loja & Permissões
            </h2>
          ...
          <button
            ...
            style={{
              ...
              background: showAddForm ? "#64748B" : "linear-gradient(135deg, #1C1917, #1C1917)",
        ...
        {showAddForm && (
          <form onSubmit={handleCreateMember} style={{ background: "#F8FAFC", borderRadius: "14px", padding: "20px", border: "1.5px solid #CBD5E1", marginBottom: "24px" }}>
            <h3 style={{ fontSize: "1.05rem", fontWeight: 800, color: "#1E293B", margin: "0 0 16px", display: "flex", alignItems: "center", gap: "6px" }}>
              <UserPlus size={18} color="#1C1917" /> Novo Login de Funcionário
            </h3>
              ...
              <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "12px", flexWrap: "wrap", gap: "8px" }}>
                <div>
                  <span style={{ fontWeight: 800, fontSize: "0.9rem", color: "#0F172A", display: "flex", alignItems: "center", gap: "6px" }}>
                    <Shield size={16} color="#0F766E" /> Módulos Liberados para este Funcionário:
                  </span>
                ...
                <div style={{ display: "flex", gap: "8px" }}>
                  <button
                    ...
                    style={{ padding: "3px 8px", fontSize: "0.72rem", fontWeight: 700, borderRadius: "6px", border: "1px solid #CBD5E1", background: "#FAF6F2", color: "#1C1917", cursor: "pointer" }}
                  >
                    Marcar Todos
                  </button>
                  <button
                  ...
                  return (
                    ...
                    >
                      <input
                        ...
                        style={{ width: 17, height: 17, marginTop: "2px", accentColor: "#0F766E", cursor: "pointer" }}
                      />
                      <div>
                        <div style={{ fontSize: "0.82rem", fontWeight: 700, color: isChecked ? "#134E4A" : "#475569" }}>
                          {m.label}
                        </div>
                ...
                >
                  <div>
                    <div style={{ display: "flex", alignItems: "center", gap: "8px" }}>
                      ...
                      <span style={{ padding: "2px 8px", borderRadius: "10px", fontSize: "0.68rem", fontWeight: 700, background: "#FAF6F2", color: "#1C1917" }}>
                        Funcionário
                      </span>
                    </div>
          ...
          <div style={{ background: "#fff", borderRadius: "16px", padding: "24px", width: "100%", maxWidth: "600px", maxHeight: "90vh", overflowY: "auto", boxShadow: "0 25px 50px rgba(0,0,0,0.25)" }}>
                  ...
                  return (
                    <div
                      ...
                      style={{
                        ...
                        border: isChecked ? "1.5px solid #0F766E" : "1px solid #CBD5E1",
                        background: isChecked ? "#F0FDFA" : "#F8FAFC",
                    ...
                    >
                      <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                        ...
                        />
                        <div>
                          <div style={{ fontSize: "0.85rem", fontWeight: 700, color: isChecked ? "#134E4A" : "#334155" }}>
                            {m.label}
                          </div>
                      ...
                      <span style={{ fontSize: "0.72rem", fontWeight: 700, padding: "2px 8px", borderRadius: "6px", background: isChecked ? "#F0FDFA" : "#F1F5F9", color: isChecked ? "#0F766E" : "#64748B" }}>
            ...
            <div style={{ display: "flex", gap: "10px" }}>
              ...
              <button
                ...
                disabled={submitting}
                style={{ flex: 1, padding: "10px", borderRadius: "8px", border: "none", background: "#0F766E", color: "#fff", fontWeight: 800, fontSize: "0.85rem", cursor: submitting ? "not-allowed" : "pointer" }}
              >
