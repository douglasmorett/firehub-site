...
export default function InvoicesClient({ role, canSeePersonal = false }: { role: string; canSeePersonal?: boolean }) {
  ...
  return (
    <div style={{ padding: "20px" }}>
      ...
      {success && (
        <div style={{ background: "#F0FDFA", color: "#0F766E", padding: "0.85rem 1rem", borderRadius: "10px", marginBottom: "1rem", display: "flex", gap: "0.5rem", alignItems: "center" }}>
          <CheckCircle size={18} /><span>{success}</span>
          <button onClick={() => setSuccess("")} style={{ marginLeft: "auto", background: "none", border: "none", cursor: "pointer", color: "#0F766E", fontSize: "1.1rem" }}>✕</button>
        </div>
      )}
      ...
      <div style={{ background: "#FFF", borderRadius: "16px", padding: "20px", border: "1px solid #E2E8F0", marginBottom: "2rem" }}>
        <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: "1rem" }}>
          ...
          <div style={{ display: "flex", background: "#f1f5f9", borderRadius: "10px", padding: "3px", gap: "2px" }}>
            ...
            <button onClick={() => { setMode("manual"); setError(""); setSuccess(""); }}
              style={{ padding: "6px 14px", borderRadius: "8px", border: "none", cursor: "pointer", fontWeight: 600, fontSize: "0.8rem", display: "flex", alignItems: "center", gap: 5, background: mode === "manual" ? "#1C1917" : "transparent", color: mode === "manual" ? "#fff" : "#64748b", fontFamily: "inherit" }}>
        ...
        {mode === "manual" && (
          <div style={{ display: "flex", flexDirection: "column", gap: "0.85rem" }}>
            <p style={{ fontSize: "0.82rem", color: "#1C1917", margin: 0, background: "#FAF6F2", padding: "8px 12px", borderRadius: 8 }}>
            ...
            <button onClick={handleManualSave} disabled={savingManual}
              style={{ width: "100%", padding: "0.9rem", borderRadius: 10, border: "none", background: savingManual ? "#94a3b8" : "#1C1917", color: "#fff", fontWeight: 700, fontSize: "1rem", cursor: savingManual ? "not-allowed" : "pointer", display: "flex", alignItems: "center", justifyContent: "center", gap: 8 }}>
              <Receipt size={18} />
                ...
                {invoices.map(inv => (
                  <tr key={inv.id} style={{ borderBottom: "1px solid #E2E8F0" }}>
                    <td style={{ padding: "0.5rem", fontSize: "0.82rem", color: "#64748b" }}>
                      ...
                      {inv.source === "manual" && <span style={{ fontSize: "0.68rem", background: "#FAF6F2", color: "#1C1917", padding: "1px 5px", borderRadius: 4, fontWeight: 700 }}>MANUAL</span>}
                    </td>
                      ...
                      <div style={{ display: "flex", justifyContent: "flex-end", gap: "0.4rem", alignItems: "center" }}>
                        ...
                        {isAdmin && (
                          <button
                            ...
                            style={{ color: "#1C1917", background: "none", border: "1px solid #1C1917", borderRadius: "6px", padding: "4px 10px", cursor: "pointer", fontSize: "0.8rem", display: "flex", alignItems: "center", gap: "4px" }}
                          >
        ...
        <div style={{ position: "fixed", inset: 0, zIndex: 9999, background: "rgba(0,0,0,0.6)", backdropFilter: "blur(4px)", display: "flex", alignItems: "center", justifyContent: "center", padding: 16 }}>
          <div style={{ background: "white", borderRadius: 16, padding: "24px", maxWidth: 500, width: "100%" }}>
            ...
            <div style={{ display: "flex", gap: "0.75rem", marginTop: "1.5rem", justifyContent: "flex-end" }}>
              ...
              <button onClick={handleEdit} disabled={editLoading} style={{ padding: "8px 20px", borderRadius: "8px", border: "none", background: "#1C1917", color: "white", cursor: "pointer", fontWeight: "bold" }}>
