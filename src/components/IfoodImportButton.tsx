...
function IfoodApiTab() {
  ...
  if (step === "preview" && preview) {
    return (
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: "1rem", background: "#F0FDFA", borderRadius: 10, padding: "0.75rem 1rem", border: "1px solid #99F6E4" }}>
          <CheckCircle size={18} color="#0F766E" />
          <span style={{ fontSize: "0.88rem", fontWeight: 800, color: "#0F766E" }}>
  ...
  if (step === "done" && result) {
    return (
      <div style={{ background: "#F0FDFA", borderRadius: 12, padding: "1.25rem", border: "1px solid #99F6E4", textAlign: "center" }}>
        <div style={{ fontSize: "2.5rem", marginBottom: 8 }}>🎉</div>
        <p style={{ fontWeight: 800, fontSize: "1.05rem", margin: "0 0 4px", color: "#0F766E" }}>Cardápio importado com sucesso!</p>
        <p style={{ fontSize: "0.85rem", color: "#0F766E", margin: "0 0 1rem" }}>{result.message}</p>
        <div style={{ display: "flex", gap: 10, justifyContent: "center" }}>
          <button onClick={reset} style={{ padding: "8px 16px", borderRadius: 8, border: "1.5px solid #0F766E", background: "#fff", color: "#0F766E", fontWeight: 700, fontSize: "0.82rem", cursor: "pointer" }}>Importar novamente</button>
          <a href="/store/cardapio" style={{ padding: "8px 18px", borderRadius: 8, border: "none", background: "#0F766E", color: "#fff", fontWeight: 800, fontSize: "0.82rem", cursor: "pointer", textDecoration: "none" }}>Ver Meus Produtos →</a>
        </div>
      </div>
    );
  }
...
function CsvImportTab() {
    ...
    return (
      <div>
        <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: "1rem", background: "#F0FDFA", borderRadius: 10, padding: "0.75rem 1rem", border: "1px solid #99F6E4" }}>
          ...
          <span style={{ fontSize: "0.875rem", fontWeight: 700, color: "#0F766E" }}>
  ...
  if (step === "done" && result) {
    return (
      <div style={{ background: "#F0FDFA", borderRadius: 10, padding: "1.25rem", border: "1px solid #99F6E4", textAlign: "center" }}>
        <div style={{ fontSize: "2.5rem", marginBottom: 8 }}>🎉</div>
        <p style={{ fontWeight: 800, fontSize: "1rem", margin: "0 0 4px", color: "#0F766E" }}>Importação concluída!</p>
        <p style={{ fontSize: "0.85rem", color: "#0F766E", margin: "0 0 1rem" }}>{result.message}</p>
        <a href="/store/cardapio" style={{ padding: "10px 24px", borderRadius: 8, border: "none", background: "#0F766E", color: "#fff", fontWeight: 700, fontSize: "0.88rem", cursor: "pointer", textDecoration: "none", display: "inline-block" }}>Ver Cardápio →</a>
      </div>
    );
  }
