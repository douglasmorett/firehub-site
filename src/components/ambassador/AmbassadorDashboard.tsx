      ...
      >
        ...
        <div style={{ display: "flex", alignItems: "center", gap: 12, flexWrap: "wrap" }}>
          <div style={{ display: "flex", alignItems: "center", gap: 8, background: "#F1F5F9", padding: "6px 14px", borderRadius: "8px", border: "1px solid #E2E8F0" }}>
            ...
            <span style={{ fontSize: "0.85rem", fontWeight: 800, color: "#0F766E" }}>{ambassador.commissionPercent}% Recorrente</span>
          </div>
      ...
      <main style={{ maxWidth: 1200, margin: "0 auto", padding: "32px 20px" }}>
        ...
        <div style={{ display: "grid", gridTemplateColumns: "repeat(auto-fit, minmax(250px, 1fr))", gap: 18, marginBottom: 28 }}>
          ...
          <div style={{ background: "#FFFFFF", border: "1.5px solid #E2E8F0", padding: "22px", borderRadius: "16px", boxShadow: "0 4px 16px rgba(0,0,0,0.03)" }}>
            <div style={{ display: "flex", justifyContent: "space-between", alignItems: "center", marginBottom: 8 }}>
              ...
              <span style={{ background: "#F0FDFA", color: "#0F766E", border: "1px solid #99F6E4", padding: "3px 8px", borderRadius: "6px", fontSize: "0.72rem", fontWeight: 800 }}>
                {ambassador.commissionPercent}%
              </span>
            </div>
            <div style={{ fontSize: "2.1rem", fontWeight: 900, color: currentMonthIncome > 0 ? "#0F766E" : "#0F172A", letterSpacing: "-0.5px" }}>
          ...
          <div style={{ background: "#FFFFFF", border: "1.5px solid #E2E8F0", padding: "22px", borderRadius: "16px", boxShadow: "0 4px 16px rgba(0,0,0,0.03)" }}>
            ...
            <div style={{ fontSize: "0.78rem", color: "#64748B", marginTop: 6, display: "flex", gap: "10px", flexWrap: "wrap" }}>
              <span style={{ color: "#0F766E", fontWeight: 700 }}>● {activeCount} ativa{activeCount !== 1 ? "s" : ""}</span>
          ...
          <div style={{ background: "#FFFFFF", border: "1.5px solid #E2E8F0", padding: "22px", borderRadius: "16px", boxShadow: "0 4px 16px rgba(0,0,0,0.03)" }}>
            ...
            <div style={{ fontSize: "2.1rem", fontWeight: 900, color: "#1C1917", letterSpacing: "-0.5px" }}>
          ...
          <div style={{ background: "#FFFFFF", border: "2px solid #C92E09", padding: "22px", borderRadius: "16px", boxShadow: "0 4px 16px rgba(220,38,38,0.08)", display: "flex", flexDirection: "column", justifyContent: "space-between" }}>
            ...
            <button
              ...
              style={{
                width: "100%",
                padding: "12px",
                background: copied ? "#0F766E" : "linear-gradient(135deg, #C92E09, #B71C1C)",
                color: "#FFF",
                border: "none",
                borderRadius: "10px",
                fontWeight: 800,
        ...
        >
          <div style={{ maxWidth: 750 }}>
            <div style={{ display: "flex", alignItems: "center", gap: 8, marginBottom: 4 }}>
              ...
              <strong style={{ fontSize: "0.98rem", color: "#1C1917" }}>
                Apresentando o FireHub para novos clientes?
              </strong>
            </div>
            <p style={{ fontSize: "0.85rem", color: "#1C1917", margin: 0, lineHeight: 1.5 }}>
            ...
            <div style={{ display: "flex", alignItems: "center", gap: "12px", flexWrap: "wrap" }}>
              ...
              <div style={{ display: "flex", background: "#F1F5F9", padding: "3px", borderRadius: "8px", border: "1px solid #E2E8F0" }}>
                ...
                <button
                  ...
                  className="amb-filter-pill"
                  style={{
                    background: statusFilter === "ACTIVE" ? "#0F766E" : "transparent",
                    color: statusFilter === "ACTIVE" ? "#FFFFFF" : "#0F766E",
                    border: "none",
                    padding: "6px 12px",
                    borderRadius: "6px",
                    fontSize: "0.78rem",
                  ...
                  {filteredStores.map((store) => {
                    ...
                    return (
                      ...
                      >
                          ...
                          <div style={{ display: "flex", alignItems: "center", gap: "10px" }}>
                            ...
                            <span
                              ...
                              style={{
                                ...
                                minWidth: "12px",
                                borderRadius: "50%",
                                background: isStoreActive ? "#0F766E" : "#0F172A",
                                boxShadow: isStoreActive ? "0 0 0 3px rgba(15, 118, 110,0.25)" : "0 0 0 3px rgba(15,23,42,0.15)",
                              }}
                            />
                            <div>
                        ...
                        {/* Ambassador Profit */}
                        <td style={{ padding: "16px 16px" }}>
                          <div style={{ fontWeight: 900, color: store.ambassadorProfit > 0 ? "#0F766E" : "#64748B", fontSize: "1.05rem" }}>
                            {formatBRL(store.ambassadorProfit)}
                          </div>
                          <div style={{ fontSize: "0.72rem", color: store.ambassadorProfit > 0 ? "#0F766E" : "#94A3B8", marginTop: 2 }}>
        ...
        >
          ...
          {ambassador.asaasWalletId ? (
            <span style={{ fontSize: "0.75rem", color: "#0F766E", fontWeight: 800, background: "#F0FDFA", border: "1px solid #99F6E4", padding: "4px 10px", borderRadius: "6px" }}>
