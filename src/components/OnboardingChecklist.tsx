              ...
              <div key={ph.id} style={{ display: "flex", alignItems: "center", flexShrink: 0 }}>
                ...
                >
                  <div style={{
                    ...
                    background: phComplete ? "#0F766E" : isCurrent ? "#E63946" : "rgba(255,255,255,0.12)",
                    border: isCurrent ? "2px solid #E63946" : phComplete ? "2px solid #0F766E" : "2px solid rgba(255,255,255,0.2)",
                ...
                {!isLast && (
                  <div style={{ width: 20, height: 2, background: isPast && !isCurrent ? "#0F766E" : "rgba(255,255,255,0.15)", marginBottom: 14, flexShrink: 0 }} />
                )}
              </div>
            );
          })}
          ...
          {phase.tasks.map(task => {
            ...
            return (
              <div
                key={task.id}
                style={{
                  borderRadius: 14, border: `1.5px solid ${isDone ? "#99F6E4" : "#E2E8F0"}`,
                  background: isDone ? "#F0FDFA" : "#FAFAFA",
                ...
                <div style={{ display: "flex", alignItems: "center", gap: 12, padding: "12px 14px" }}>
                  ...
                  <div
                    style={{
                      ...
                      border: isDone ? "2px solid #0F766E" : "2px solid #CBD5E1",
                      background: isDone ? "#0F766E" : "#fff",
                      display: "flex", alignItems: "center", justifyContent: "center",
                      transition: "all 0.2s",
                    }}
                  >
                      ...
                      <div style={{ marginTop: 6 }}>
                        ...
                        <div style={{ marginTop: 6, display: "flex", flexDirection: "column", gap: 3 }}>
                          {task.subTasks?.map(sub => {
                            ...
                            return (
                              <div key={subId} style={{ display: "flex", alignItems: "center", gap: 6, fontSize: "0.75rem", color: isSubDone ? "#0F766E" : "#475569" }}>
                                <input
                                  type="checkbox"
                                  checked={isSubDone}
                                  readOnly
                                  style={{ accentColor: "#0F766E", width: 13, height: 13, cursor: "default", pointerEvents: "none" }}
                                />
                                {sub.label}
                              </div>
                            );
